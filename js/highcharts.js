...
(function (R, K) {
    ...
    var K = function () {
        var a = "undefined" === typeof R ? window : R, x = a.document, E = a.navigator && a.navigator.userAgent || "",
            C = x && x.createElementNS && !!x.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
            p = /(edge|msie|trident)/i.test(E) && !a.opera, m = -1 !== E.indexOf("Firefox"),
            e = -1 !== E.indexOf("Chrome"), k = m && 4 > parseInt(E.split("Firefox/")[1],
            10);
    ...
    (function (a) {
        a.timers = [];
        var x = a.charts, E = a.doc, C = a.win;
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0], m = this.paths[1], e = [], k = this.now, w = a.length, t;
                if (1 === k) e = this.toD; else if (w === m.length && 1 > k) for (; w--;) t = parseFloat(a[w]), e[w] = isNaN(t) ? m[w] : k * parseFloat(m[w] - t) + t; else e = m;
                this.elem.attr("d",
                    e, null, !0)
            }, update: function () {
                var a = this.elem, m = this.prop, e = this.now, k = this.options.step;
                if (this[m + "Setter"]) this[m + "Setter"](); else a.attr ? a.element && a.attr(m, e, null, !0) : a.style[m] = e + this.unit;
                k && k.call(a, e, this)
            }, run: function (p, m, e) {
                var k = this, w = k.options, t = function (a) {
                ...
                p === m ? (delete w.curAnim[this.prop],
                w.complete && 0 === a.keys(w.curAnim).length && w.complete.call(this.elem)) : (this.startTime = +new Date, this.start = p, this.end = m, this.unit = e, this.now = this.start, this.pos = 0, t.elem = this.elem, t.prop = this.prop, t() && 1 === a.timers.push(t) && n(c))
            }, step: function (p) {
                var m = +new Date, e, k = this.options, w = this.elem, t = k.complete, n = k.duration, c = k.curAnim;
                w.attr && !w.element ? p = !1 : p || m >= n + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), e = c[this.prop] = !0, a.objectEach(c, function (a) {
                    ...
                    !1) : (this.pos = k.easing((m - this.startTime) / n), this.now = this.start + (this.end - this.start) * this.pos, this.update(), p = !0);
                return p
                ...
                function t(a, c) {
                    for (var d =
                        (f - a.length) / h; 0 < d && d--;) b = a.slice().splice(a.length / H - h, h * H), b[0] = c[f - h - d * h], A && (b[h - 6] = b[h - 2], b[h - 5] = b[h - 1]), [].splice.apply(a, [a.length / H, 0].concat(b)), q && d--
                }

                m = m || "";
                var n, c = p.startX, d = p.endX, A = -1 < m.indexOf("C"), h = A ? 7 : 3, f, b, u;
                m = m.split(" ");
                e = e.slice();
                var q = p.isArea, H = q ? 2 : 1, M;
                A && (k(m), k(e));
                if (c && d) {
                    for (u = 0; u < c.length; u++) if (c[u] === d[0]) {
                        n = u;
                        break
                ...
                m.length && a.isNumber(n) && (f = e.length + n * H * h, M ? (w(m, e), t(e, m)) : (w(e, m), t(m,
                    e)));
                return [m, e]
            }
        };
        ...
        a.merge = function () {
            var p, m = arguments, e, k = {}, w = function (e, n) {
                "object" !== typeof e && (e = {});
        ...
        a.pick = function () {
            var a = arguments, m, e, k = a.length;
            for (m = 0; m < k; m++) if (e = a[m], void 0 !== e && null !== e) return e
        };
        a.css = function (p, m) {
        ...
        a.createElement = function (p, m, e, k, w) {
            ...
            var t = a.css;
            m && a.extend(p, m);
            w && t(p, {padding: 0, border: "none", margin: 0});
            e && t(p, e);
            k && k.appendChild(p);
            return p
        };
        a.extendClass = function (p,
                                  m) {
            var e = function () {
            };
            e.prototype = new p;
        ...
        a.wrap = function (a, m, e) {
            var k = a[m];
            a[m] = function () {
                var a = Array.prototype.slice.call(arguments), m = arguments, n = this;
                n.proceed = function () {
        ...
        a.formatSingle = function (p,
                                   m, e) {
            var k = /\.([0-9])/, w = a.defaultOptions.lang;
        ...
        a.arrayMin = function (a) {
            for (var m = a.length, e = a[0]; m--;) a[m] < e && (e = a[m]);
            return e
        };
        ...
        a.numberFormat = function (p, m, e, k) {
            p = +p || 0;
            m = +m;
            var w = a.defaultOptions.lang, t = (p.toString().split(".")[1] || "").split("e")[0].length, n,
                c, d = p.toString().split("e");
        ...
        a.getStyle = function (p, m, e) {
            ...
            if ("height" === m) return Math.min(p.offsetHeight, p.scrollHeight) - a.getStyle(p, "padding-top") - a.getStyle(p, "padding-bottom");
            C.getComputedStyle || a.error(27, !0);
            if (p = C.getComputedStyle(p, void 0)) p = p.getPropertyValue(m), a.pick(e, "opacity" !== m) && (p = a.pInt(p));
            return p
        };
        ...
        a.find = Array.prototype.find ? function (a, m) {
            ...
            var e, k = a.length;
            for (e = 0; e < k; e++) if (m(a[e], e)) return a[e]
        };
        a.map = function (a, m) {
            for (var e = [], k = 0, w = a.length; k < w; k++) e[k] = m.call(a[k], a[k], k, a);
            return e
        };
        a.keys = function (p) {
        ...
        a.reduce = function (p, m, e) {
            return (a.reducePolyfill ||
                Array.prototype.reduce).call(p, m, e)
        };
        a.offset = function (a) {
        ...
        a.stop = function (p, m) {
            for (var e = a.timers.length; e--;) a.timers[e].elem !== p || m && m !== a.timers[e].prop || (a.timers[e].stopped = !0)
        };
        ...
        a.objectEach = function (a,
                                 m, e) {
            for (var k in a) a.hasOwnProperty(k) && m.call(e, a[k], k, a)
        };
        ...
        a.addEvent = function (p, m, e) {
            var k, w = p.addEventListener || a.addEventListenerPolyfill;
        ...
        a.removeEvent = function (p, m, e) {
            ...
            function w(c) {
                ...
                p.nodeName && (m ? (d = {}, d[m] = !0) : d = c, a.objectEach(d, function (a, f) {
                    if (c[f]) for (n = c[f].length; n--;) k(f, c[f][n])
                }))
            }
        ...
        a.fireEvent = function (p, m, e, k) {
            var w, t, n, c, d;
            e = e || {};
            E.createEvent && (p.dispatchEvent || p.fireEvent) ? (w = E.createEvent("Events"), w.initEvent(m, !0, !0),
                a.extend(w, e), p.dispatchEvent ? p.dispatchEvent(w) : p.fireEvent(m, w)) : a.each(["protoEvents", "hcEvents"], function (k) {
                if (p[k]) for (t = p[k][m] || [], n = t.length, e.target || a.extend(e, {
                    preventDefault: function () {
                        e.defaultPrevented = !0
                    }, target: p, type: m
                }), c = 0; c < n; c++) (d = t[c]) && !1 === d.call(p, e) && e.preventDefault()
            });
        ...
        a.animate = function (p, m, e) {
            ...
            e.easing = "function" ===
            typeof e.easing ? e.easing : Math[e.easing] || Math.easeInOutSine;
            e.curAnim = a.merge(m);
        ...
        a.seriesType = function (p, m, e, k, w) {
            ...
            n[p] = a.extendClass(n[m] || function () {
            },
                k);
        ...
        C.jQuery && (C.jQuery.fn.highcharts = function () {
            ...
            if (this[0]) return p[0] ? (new (a[a.isString(p[0]) ? p.shift() : "Chart"])(this[0], p[0], p[1]), this) : x[a.attr(this[0], "data-highcharts-chart")]
        })
    })(K);
    (function (a) {
        var x = a.each, E = a.isNumber, C = a.map, p = a.merge, m = a.pInt;
        a.Color = function (e) {
        ...
        a.Color.prototype = {
            parsers: [{
                ...
                var k,
                    m, t, n;
                if ((this.input = e = this.names[e && e.toLowerCase ? e.toLowerCase() : ""] || e) && e.stops) this.stops = C(e.stops, function (c) {
                    return new a.Color(c[1])
                }); else if (e && e.charAt && "#" === e.charAt() && (k = e.length, e = parseInt(e.substr(1), 16), 7 === k ? m = [(e & 16711680) >> 16, (e & 65280) >> 8, e & 255, 1] : 4 === k && (m = [(e & 3840) >> 4 | (e & 3840) >> 8, (e & 240) >> 4 | e & 240, (e & 15) << 4 | e & 15, 1])), !m) for (t = this.parsers.length; t-- && !m;) n = this.parsers[t], (k = n.regex.exec(e)) && (m = n.parse(k));
                this.rgba = m || []
            }, get: function (a) {
                var e = this.input, m = this.rgba, t;
                this.stops ?
                    (t = p(e), t.stops = [].concat(t.stops), x(this.stops, function (n, c) {
                ...
                if (this.stops) x(this.stops, function (e) {
                    e.brighten(a)
                }); else if (E(a) && 0 !== a) for (e = 0; 3 > e; e++) w[e] += m(255 * a), 0 > w[e] && (w[e] = 0), 255 < w[e] && (w[e] = 255);
                return this
    ...
    (function (a) {
        var x, E, C = a.addEvent, p = a.animate, m = a.attr, e = a.charts, k = a.color, w = a.css, t = a.createElement,
            n = a.defined, c = a.deg2rad, d = a.destroyObjectProperties, A = a.doc, h = a.each, f = a.extend,
            b = a.erase, u = a.grep,
            q = a.hasTouch, H = a.inArray, M = a.isArray, D = a.isFirefox, F = a.isMS, z = a.isObject, r = a.isString,
            y = a.isWebKit, G = a.merge, B = a.noop, I = a.objectEach, g = a.pick, v = a.pInt, L = a.removeEvent,
            l = a.splat, J = a.stop, S = a.svg, Q = a.SVG_NS, P = a.symbolSizes, O = a.win;
        ...
        f(x.prototype, {
            ...
            init: function (a, g) {
                this.element = "span" === g ? t(g) : A.createElementNS(this.SVG_NS,
                    g);
                this.renderer = a
            },
            ...
            colorGradient: function (g, b, l) {
                var N = this.renderer, v, c, f, r, d, q, u, e, J, L, y = [], T;
                ...
                c && L && !n(f.gradientUnits) && (r = f, f = G(f, N.getRadialAttr(L, r), {gradientUnits: "userSpaceOnUse"})), I(f, function (a, g) {
                    "id" !== g && y.push(g, a)
                }), I(u, function (a) {
                    y.push(a)
                    ...
                    g = N.createElement("stop").attr({offset: g[0], "stop-color": e, "stop-opacity": J}).add(q);
                    q.stops.push(g)
                })), T = "url(" +
                    N.url + "#" + L + ")", l.setAttribute(b, T), l.gradient = y, g.toString = function () {
                    return T
                })
            },
            applyTextOutline: function (g) {
                var l = this.element, N, v, c, f, r;
                ...
                if ((c = g[0]) && "none" !== c && a.svg) {
                    ...
                    for (r = g.length; r--;) N = g[r], "highcharts-text-outline" ===
                    N.getAttribute("class") && b(g, l.removeChild(N));
                    f = l.firstChild;
                    h(g, function (a, g) {
            ...
            addClass: function (a, g) {
                ...
                -1 === l.indexOf(a) && (g || (a =
                    (l + (l ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                return this
            },
            hasClass: function (a) {
            ...
            css: function (a) {
                var g = this.styles, l = {}, b = this.element, c, N = "", h, r = !g,
                ...
                r && (g && (a = f(g,
                    l)), c = this.textWidth = a && a.width && "auto" !== a.width && "text" === b.nodeName.toLowerCase() && v(a.width), this.styles = a, c && !S && this.renderer.forExport && delete a.width, b.namespaceURI === this.SVG_NS ? (h = function (a, g) {
            ...
            strokeWidth: function () {
                var a = this.getStyle("stroke-width"), g;
            ...
            on: function (a, g) {
                ...
                q && "click" === a ? (b.ontouchstart = function (a) {
                    ...
                    (-1 === O.navigator.userAgent.indexOf("Android") ||
                        1100 < Date.now() - (l.touchEventFired || 0)) && g.call(b, a)
                }) : b["on" + a] = g;
                return this
            },
            ...
            updateTransform: function () {
                var a = this.translateX || 0, l = this.translateY || 0, b = this.scaleX,
                    c = this.scaleY, v = this.inverted, f = this.rotation, h = this.matrix, r = this.element;
            ...
            align: function (a, l, c) {
                ...
                var q, u;
                if (a) {
                    if (this.alignOptions = a, this.alignByTranslate = l, !c || r(c)) this.alignTo = v = c || "renderer", b(h, this), h.push(this), c = null
                } else a = this.alignOptions, l = this.alignByTranslate, v = this.alignTo;
                c = g(c, f[v], f);
                v = a.align;
                f = a.verticalAlign;
                h = (c.x || 0) + (a.x || 0);
            ...
            getBBox: function (a, l) {
                var b, v = this.renderer, r, d = this.element, N = this.styles, q, u = this.textStr, e, J = v.cache,
                    L = v.cacheKeys, y;
                l = g(l, this.rotation);
                r = l * c;
                ...
                if (!b) {
                    ...
                    v.isSVG && (a = b.width, v = b.height, N && "11px" === N.fontSize && 17 === Math.round(v) && (b.height = v = 14), l && (b.width = Math.abs(v * Math.sin(r)) + Math.abs(a * Math.cos(r)), b.height = Math.abs(v * Math.cos(r)) + Math.abs(a *
                        Math.sin(r))));
                    if (y && 0 < b.height) {
                        for (; 250 < L.length;) delete J[L.shift()];
                        J[y] || L.push(y);
                        J[y] = b
                    }
                }
            ...
            add: function (a) {
                var g = this.renderer, l = this.element, b;
            ...
            destroy: function () {
                var a = this, g = a.element || {}, l = a.renderer.isSVG && "SPAN" === g.nodeName && a.parentGroup,
                ...
                for (a.safeRemoveChild(g); l && l.div && 0 === l.div.childNodes.length;) g = l.parentGroup, a.safeRemoveChild(l.div), delete l.div, l = g;
            ...
            fillSetter: function (a, g, l) {
                "string" === typeof a ? l.setAttribute(g,
                    a) : a && this.colorGradient(a, g, l)
            },
            ...
            zIndexSetter: function (a, g) {
                var l = this.renderer, b = this.parentGroup, c = (b || l).element || l.box, f, h = this.element, r, d,
                    l = c === l.box;
                f = this.added;
                var q;
                ...
                if (f) {
                    ...
                    g = c.childNodes;
                    for (q = g.length - 1; 0 <= q && !r; q--) if (b = g[q], f = b.zIndex, d = !n(f), b !== h) if (0 > a && d && !l && !q) c.insertBefore(h, g[q]),
                        r = !0; else if (v(f) <= a || d && (!n(a) || 0 <= a)) c.insertBefore(h, g[q + 1] || null), r = !0;
        ...
        f(E.prototype, {
            ...
            init: function (a, g, l, b, v, c) {
                ...
                this.boxWrapper = b;
                this.alignedObjects = [];
                this.url = (D || y) && A.getElementsByTagName("base").length ? O.location.href.replace(/#.*?$/, "").replace(/<[^>]*>/g,
                ...
                D && a.getBoundingClientRect && (g = function () {
                    ...
                    w(a, {left: Math.ceil(h.left) - h.left + "px", top: Math.ceil(h.top) - h.top + "px"})
                }, g(), this.unSubPixelFix =
                    C(O, "resize", g))
            },
            definition: function (a) {
                function g(a, v) {
                    var c;
                    h(l(a), function (a) {
                        var l = b.createElement(a.tagName), f = {};
                        I(a, function (a, g) {
            ...
            applyEllipsis: function (a, g, l, b) {
                var v = a.rotation, c = l, f, h = 0, r = l.length, d = function (a) {
                ...
                if (q = c > b) {
                    for (; h <= r;) f = Math.ceil((h + r) / 2), c = l.substring(0, f) + "\u2026", d(c), c = this.getSpanWidth(a, g), h === r ? h = r + 1 : c > b ? r = f - 1 : h = f;
                    0 === r && d("")
                }
                a.rotation = v;
                return q
            ...
            buildText: function (a) {
                var l = a.element, b = this, c = b.forExport, f = g(a.textStr, "").toString(),
                    r = -1 !== f.indexOf("\x3c"), d = l.childNodes, q, n, e, J, y = m(l, "x"), L = a.styles,
                    G = a.textWidth, k = L && L.lineHeight, B = L && L.textOutline,
                    N = L && "ellipsis" === L.textOverflow, F = L && "nowrap" === L.whiteSpace, z, D = d.length,
                    t = G && !a.added && this.box, p = function (a) {
                ...
                if (L !== a.textCache) {
                    for (a.textCache = L; D--;) l.removeChild(d[D]);
                    r || B || N || G || -1 !== f.indexOf(" ") ? (q = /<.*class="([^"]+)".*>/, n = /<.*style="([^"]+)".*>/, e = /<.*href="([^"]+)".*>/,
                    t && t.appendChild(l), f = r ? f.replace(/<(b|strong)>/g, '\x3cspan class\x3d"highcharts-strong"\x3e').replace(/<(i|em)>/g, '\x3cspan class\x3d"highcharts-emphasized"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [f], f = u(f, function (a) {
                        return "" !== a
                    }), h(f, function (g, v) {
                        var f, r = 0;
                        ...
                        h(f, function (g) {
                            if ("" !== g || 1 === f.length) {
                                var h = {}, d = A.createElementNS(b.SVG_NS,
                                    "tspan"), u, L;
                                ...
                                if (" " !== g) {
                                    ...
                                    if (G) {
                                        ...
                                        u = 1 <
                                            f.length || v || 1 < h.length && !F;
                                        var k = [], B, D = p(d), H = a.rotation;
                                        for (N && (J = b.applyEllipsis(a, d, g, G)); !N && u && (h.length || k.length);) a.rotation = 0, B = b.getSpanWidth(a, d), g = B > G, void 0 === J && (J = g), g && 1 !== h.length ? (d.removeChild(d.firstChild), k.unshift(h.pop())) : (h = k, k = [], h.length && !F && (d = A.createElementNS(Q, "tspan"), m(d, {
                                            dy: D,
                                            x: y
                        ...
                        M(a.textStr, ["\x26lt;", "\x26gt;"])), t && t.removeChild(l), B && a.applyTextOutline && a.applyTextOutline(B)) : l.appendChild(A.createTextNode(M(f)))
                }
            },
            ...
            button: function (a, g, l, b, c, v, f, h, d) {
                var r = this.label(a, g, l, d, null, null, null, null, "button"), q = 0;
                r.attr(G({padding: 8, r: 2}, c));
            ...
            arc: function (a, g, l, b, c, v) {
                z(a) ? (b = a, g = b.y, l = b.r, a = b.x) : b = {innerR: b, start: c, end: v};
            ...
            rect: function (a, g, l, b, c, v) {
                ...
                a = z(a) ? a : void 0 === a ? {} : {x: a, y: g, width: Math.max(l, 0), height: Math.max(b, 0)};
                c && (a.r = c);
            ...
            setSize: function (a, l, b) {
                ...
                this.width = a;
                this.height = l;
                for (this.boxWrapper.animate({width: a, height: l}, {
                    step: function () {
            ...
            image: function (a, g, l, b, c) {
                ...
                1 < arguments.length && f(v, {x: g, y: l, width: b, height: c});
            ...
            symbol: function (a, l, b, c, v, r) {
                var d = this, q, u = /^url\((.*?)\)$/, L = u.test(a), J = !L && (this.symbols[a] ? a : "circle"),
                    y = J && this.symbols[J],
                    G = n(l) && y && y.call(this.symbols, Math.round(l), Math.round(b), c, v, r), k, B;
                y ? (q = this.path(G), f(q, {
                    symbolName: J,
                    x: l,
                    y: b,
                    ...
                    h(["width", "height"], function (a) {
                        q[a + "Setter"] = function (a, g) {
                            var l = {}, b = this["img" + g], c = "width" === g ? "translateX" : "translateY";
                            this[g] = a;
                    ...
                    x: l,
                    y: b
                }), q.isImg = !0, n(q.imgwidth) && n(q.imgheight) ? B() : (q.attr({width: 0, height: 0}), t("img", {
                    onload: function () {
                        var a = e[d.chartIndex];
                        0 === this.width && (w(this, {position: "absolute", top: "-999em"}), A.body.appendChild(this));
                        P[k] = {
                            width: this.width,
                            height: this.height
                        };
            ...
            symbols: {
                circle: function (a, g, l, b) {
                    return this.arc(a + l / 2, g + b / 2, l / 2, b / 2, {start: 0, end: 2 * Math.PI, open: !1})
                    ...
                    var c =
                        Math.min(v && v.r || 0, l, b), f = c + 6, h = v && v.anchorX;
                    v = v && v.anchorY;
                    var r;
                    ...
                    h && h > l ? v > g + f && v < g + b - f ? r.splice(13, 3, "L", a + l, v - 6, a + l + 6, v, a + l, v + 6, a + l, g + b - c) : r.splice(13, 3, "L", a + l, b / 2, h, v, a + l, b / 2, a + l, g + b - c) : h && 0 > h ? v > g + f && v < g + b - f ? r.splice(33, 3, "L", a, v + 6, a - 6, v, a, v - 6, a, g + c) : r.splice(33, 3, "L", a, b / 2, h, v, a, b / 2, a, g + c) : v && v > b && h > a + f && h < a + l - f ? r.splice(23, 3, "L", h + 6, g +
                        b, h, g + b + 6, h - 6, g + b, a + c, g + b) : v && 0 > v && h > a + f && h < a + l - f && r.splice(3, 3, "L", h - 6, g, h, g - 6, h + 6, g, l - c, g);
                    return r
                }
            },
            ...
            text: function (a, g, l, b) {
                var v = {};
                if (b && (this.allowHTML || !this.forExport)) return this.html(a, g, l);
                v.x = Math.round(g || 0);
                l && (v.y = Math.round(l));
                if (a || 0 === a) v.text = a;
                ...
                b || (a.xSetter = function (a,
                                            g, l) {
                    var b = l.getElementsByTagName("tspan"), v, c = l.getAttribute(g), f;
                    for (f = 0; f < b.length; f++) v = b[f], v.getAttribute(g) === c && v.setAttribute(g, a);
                    l.setAttribute(g, a)
                });
                return a
            },
            ...
            label: function (g, l, b, v, c, r, d, q, u) {
                var e = this, J = e.g("button" !== u && "label"), y = J.text = e.text("", 0, 0, d).attr({zIndex: 1}), k,
                    B, m = 0, F = 3, z = 0, D, S, H, A, t, Q = {}, w, I = /^url\((.*?)\)$/.test(v), p = I, M, N, P, O;
                ...
                N = function () {
                    ...
                    p && (k || (J.box = k = e.symbols[v] || I ? e.symbol(v) :
                        e.rect(), k.addClass(("button" === u ? "" : "highcharts-label-box") + (u ? " highcharts-" + u + "-box" : "")), k.add(J), a = M(), g.x = a, g.y = (q ? -w : 0) + a), g.width = Math.round(J.width), g.height = Math.round(J.height), k.attr(f(g, Q)), Q = {})
                };
                P = function () {
                    var a = z + F, g;
                    g = q ? 0 : w;
                    n(D) && B && ("center" === t || "right" === t) && (a += {center: .5, right: 1}[t] * (D - B.width));
                ...
                J.onAdd = function () {
                    y.add(J);
                    J.attr({text: g || 0 === g ? g : "", x: l, y: b});
                    k && n(c) &&
                    J.attr({anchorX: c, anchorY: r})
                };
                ...
                return f(J, {
                    css: function (a) {
                        ...
                        return {
                            width: B.width +
                            2 * F, height: B.height + 2 * F, x: B.x - F, y: B.y - F
                        }
                    }, destroy: function () {
    ...
    (function (a) {
        var x = a.attr, E = a.createElement, C = a.css, p = a.defined, m = a.each, e = a.extend, k = a.isFirefox,
            w = a.isMS, t = a.isWebKit, n = a.pick, c = a.pInt, d = a.SVGRenderer, A = a.win, h = a.wrap;
        e(a.SVGElement.prototype, {
            htmlCss: function (a) {
                ...
                if (this.added) {
                    var a = this.renderer, b = this.element, h = this.x || 0, d = this.y || 0,
                        n = this.textAlign || "left", e = {left: 0, center: .5, right: 1}[n], k = this.styles,
                        F = k && k.whiteSpace;
                    C(b, {
                        marginLeft: this.translateX ||
                        0, marginTop: this.translateY || 0
                    });
                    this.inverted && m(b.childNodes, function (c) {
                        a.invertChild(c, b)
                    });
                    if ("SPAN" === b.tagName) {
                        var k = this.rotation, z = this.textWidth && c(this.textWidth),
                            r = [k, n, b.innerHTML, this.textWidth, this.textAlign].join(), y;
                        ...
                        C(b, {left: h + (this.xCorr || 0) + "px", top: d + (this.yCorr || 0) + "px"});
                        this.cTT = r;
                        this.oldRotation = k
                    }
                } else this.alignOnAdd = !0
            }, setSpanRotation: function (a, b, c) {
                var f = {}, h = this.renderer.getTransformKey();
        ...
        e(d.prototype, {
            getTransformKey: function () {
                ...
                var f = this.createElement("span"), d = f.element, u = f.renderer, k = u.isSVG, F = function (a, b) {
                ...
                f.attr({text: a, x: Math.round(b), y: Math.round(c)}).css({position: "absolute"});
                d.style.whiteSpace = "nowrap";
                f.css = f.htmlCss;
                k && (f.add = function (a) {
                    var b, c = u.box.parentNode, h = [];
                            ...
                            m(h.reverse(), function (a) {
                                ...
                                e(a, {
                                    classSetter: function (a) {
                                        ...
                                        h[0].div && f.on.apply({element: h[0].div},
                                            arguments);
                                        return a
    ...
    (function (a) {
        var x = a.defined, E = a.each, C = a.extend, p = a.merge, m = a.pick, e = a.timeUnits, k = a.win;
        a.Time = function (a) {
            this.update(a, !1)
        };
        a.Time.prototype = {
            defaultOptions: {}, update: function (e) {
                var t = m(e && e.useUTC, !0), n = this;
                ...
                (this.variableTimezone = !(t && !e.getTimezoneOffset && !e.timezone)) || this.timezoneOffset ? (this.get = function (a, d) {
                    var c = d.getTime(), h = c - n.getTimezoneOffset(d);
                    d.setTime(h);
                    a = d["getUTC" + a]();
                    d.setTime(c);
                    return a
                    ...
                    var h;
                    if (-1 !== a.inArray(c, ["Milliseconds", "Seconds", "Minutes"])) d["set" + c](e); else h = n.getTimezoneOffset(d), h = d.getTime() - h, d.setTime(h), d["setUTC" + c](e), c = n.getTimezoneOffset(d), h = d.getTime() + c, d.setTime(h)
                }) : t ? (this.get =
                    function (a, d) {
                        return d["getUTC" + a]()
                ...
                var e =
                    this, m = this.options, n = k.moment;
                ...
                var c = this, d = new this.Date(k),
                    m = this.get("Hours", d), h = this.get("Day", d), f = this.get("Date", d), b = this.get("Month", d),
                    u = this.get("FullYear", d), q = a.defaultOptions.lang, H = q.weekdays, t = q.shortWeekdays,
                    D = a.pad, d = a.extend({
                ...
                a.objectEach(d, function (a, b) {
                    for (; -1 !==
                           e.indexOf("%" + b);) e = e.replace("%" + b, "function" === typeof a ? a.call(c, k) : a)
                });
                return n ? e.substr(0, 1).toUpperCase() + e.substr(1) : e
            }, getTimeTicks: function (a, k, n, c) {
                var d = this, A = [], h = {}, f, b = new d.Date(k), u = a.unitRange, q = a.count || 1, H;
                if (x(k)) {
                    ...
                    u >= e.hour && d.set("Hours", b, u >=
                    e.day ? 0 : q * Math.floor(d.get("Hours", b) / q));
                    ...
                    f = d.get("FullYear", b);
                    c = d.get("Month", b);
                    var t = d.get("Date", b), D = d.get("Hours", b);
                    k = b.getTime();
                    d.variableTimezone && (H = n - k > 4 * e.month || d.getTimezoneOffset(k) !== d.getTimezoneOffset(n));
                    b = b.getTime();
                    for (k = 1; b < n;) A.push(b), b = u === e.year ? d.makeTime(f + k * q, 0) : u === e.month ? d.makeTime(f, c + k * q) : !H || u !== e.day && u !== e.week ? H && u === e.hour && 1 < q ? d.makeTime(f, c, t, D + k * q) : b + u * q : d.makeTime(f, c, t + k * q * (u === e.day ? 1 : 7)), k++;
                    A.push(b);
                    u <= e.hour && 1E4 > A.length && E(A, function (a) {
                        0 === a % 18E5 && "000000000" === d.dateFormat("%H%M%S%L", a) && (h[a] = "day")
                    })
                }
                A.info = C(a, {higherRanks: h, totalRange: u * q});
                return A
            }
        }
    })(K);
        ...
        a.defaultOptions = {
            ...
            legend: {
                enabled: !0, align: "center", layout: "horizontal", labelFormatter: function () {
                    return this.name
                }, borderColor: "#999999", borderRadius: 0, navigation: {}, itemCheckboxStyle: {
                    position: "absolute", width: "13px",
                    height: "13px"
                }, squareSymbol: !0, symbolPadding: 5, verticalAlign: "bottom", x: 0, y: 0, title: {}
            },
            loading: {},
            tooltip: {
                enabled: !0,
    ...
    (function (a) {
        var x = a.correctFloat, E = a.defined, C = a.destroyObjectProperties, p = a.isNumber, m = a.pick, e = a.deg2rad;
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var a = this.axis, e = a.options, t = a.chart, n = a.categories,
                    c = a.names, d = this.pos, A = e.labels, h = a.tickPositions, f = d === h[0],
                    b = d === h[h.length - 1], c = n ? m(n[d], c[d], d) : d, n = this.label, h = h.info, u;
                ...
                if (E(n)) n && n.attr({text: e}); else {
                    if (this.label = n = E(e) && A.enabled ? t.renderer.text(e, 0, 0, A.useHTML).add(a.labelGroup) : null) n.textPxLength = n.getBBox().width;
                    this.rotation = 0
                }
            }, getLabelSize: function () {
                return this.label ? this.label.getBBox()[this.axis.horiz ? "height" : "width"] : 0
            }, handleOverflow: function (a) {
                var k = this.axis, t = k.options.labels, n = a.x, c = k.chart.chartWidth, d = k.chart.spacing,
                    A = m(k.labelLeft, Math.min(k.pos, d[3])),
                    d = m(k.labelRight, Math.max(k.isRadial ? 0 : k.pos + k.len, c - d[1])), h = this.label,
                    f = this.rotation, b = {left: 0, center: .5, right: 1}[k.labelAlign || h.attr("align")],
                    u = h.getBBox().width, q = k.getSlotWidth(), H = q, p = 1, D, F = {};
                if (f || !1 === t.overflow) 0 > f && n - b * u < A ?
                    D = Math.round(n / Math.cos(f * e) - A) : 0 < f && n + b * u > d && (D = Math.round((c - n) / Math.cos(f * e))); else if (c = n + (1 - b) * u, n - b * u < A ? H = a.x + H * (1 - b) - A : c > d && (H = d - a.x + H * b, p = -1), H = Math.min(q, H), H < q && "center" === k.labelAlign && (a.x += p * (q - H - b * (q - Math.min(u, H)))), u > H || k.autoRotation && (h.styles || {}).width) D = H;
                D && (F.width = D, (t.style || {}).textOverflow || (F.textOverflow = "ellipsis"), h.css(F))
            }, getPosition: function (e, m, t, n) {
                var c = this.axis, d = c.chart, k = n && d.oldChartHeight || d.chartHeight;
                return {
                    x: e ? a.correctFloat(c.translate(m + t, null, null,
                        n) + c.transB) : c.left + c.offset + (c.opposite ? (n && d.oldChartWidth || d.chartWidth) - c.right - c.left : 0),
                ...
                var f = this.axis, b = f.transA, u = f.reversed, q = f.staggerLines, k = f.tickRotCorr || {x: 0, y: 0},
                    p = c.y, D = n || f.reserveSpaceDefault ? 0 : -f.labelOffset * ("center" === f.labelAlign ? .5 : 1);
                E(p) || (p = 0 === f.side ? t.rotation ? -8 : -t.getBBox().height : 2 === f.side ? k.y + 8 : Math.cos(t.rotation * e) *
                    (k.y - t.getBBox(!1, 0).height / 2));
                ...
                var n = this.axis, c = this.gridLine, d = {}, k = this.pos, h = this.type, f = n.tickmarkOffset,
                    b = n.chart.renderer;
                c || (h || (d.zIndex = 1), a && (d.opacity = 0), this.gridLine = c = b.path().attr(d).addClass("highcharts-" +
                    (h ? h + "-" : "") + "grid-line").add(n.gridGroup));
                if (!a && c && (a = n.getPlotLinePath(k + f, c.strokeWidth() * m, a, !0))) c[this.isNew ? "attr" : "animate"]({
                    d: a,
                    opacity: e
                })
            }, renderMark: function (a, e, m) {
                var n = this.axis, c = n.chart.renderer, d = this.type, k = n.tickSize(d ? d + "Tick" : "tick"),
                    h = this.mark, f = !h, b = a.x;
                a = a.y;
                k && (n.opposite && (k[0] = -k[0]), f && (this.mark = h = c.path().addClass("highcharts-" + (d ? d + "-" : "") + "tick").add(n.axisGroup)), h[f ? "attr" : "animate"]({
                    ...
                    opacity: e
                                      ...
                                      e, t, n) {
                var c = this.axis, d = c.horiz, k = c.options, h = this.label, f = k.labels, b = f.step,
                    c = c.tickmarkOffset, u = !0, q = a.x;
                a = a.y;
                ...
                var n =
                        this.axis, c = n.horiz, d = this.getPosition(c, this.pos, n.tickmarkOffset, p), k = d.x, h = d.y,
    ...
    var U = function (a) {
        var x = a.addEvent, E = a.animObject, C = a.arrayMax, p = a.arrayMin, m = a.correctFloat, e = a.defaultOptions,
            k = a.defined, w = a.deg2rad, t = a.destroyObjectProperties, n = a.each, c = a.extend, d =
                a.fireEvent, A = a.format, h = a.getMagnitude, f = a.grep, b = a.inArray, u = a.isArray, q = a.isNumber,
            H = a.isString, M = a.merge, D = a.normalizeTickInterval, F = a.objectEach, z = a.pick, r = a.removeEvent,
            y = a.splat, G = a.syncTimeout, B = a.Tick, I = function () {
                this.init.apply(this, arguments)
            };
        a.extend(I.prototype, {
            ...
            init: function (a, v) {
                ...
                l.lin2log = c.linearToLogConverter ||
                    l.lin2log;
            ...
            defaultLabelFormatter: function () {
                var g = this.axis, b = this.value, c = g.chart.time, l = g.categories, f = this.dateTimeLabelFormat,
                    h = e.lang, d = h.numericSymbols, h = h.numericSymbolMagnitude || 1E3, r = d && d.length,
                    q, u = g.options.labels.format, g = g.isLog ? Math.abs(b) : g.tickInterval;
                if (u) q = A(u, this, c); else if (l) q = b; else if (f) q = c.dateFormat(f, b); else if (r && 1E3 <= g) for (; r-- && void 0 === q;) c = Math.pow(h, r + 1), g >= c && 0 === 10 * b % c && null !== d[r] && 0 !== b && (q = a.numberFormat(b / c, -1) + d[r]);
            ...
            getSeriesExtremes: function () {
                ...
                n(a.series, function (g) {
                    if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                        var l = g.options, c = l.threshold, v;
                        a.hasVisibleSeries = !0;
                        a.positiveValuesOnly && 0 >= c && (c = null);
                        if (a.isXAxis) l = g.xData, l.length && (g = p(l), v = C(l), q(g) || g instanceof Date || (l = f(l, q), g = p(l), v = C(l)), l.length && (a.dataMin = Math.min(z(a.dataMin, l[0], g), g), a.dataMax = Math.max(z(a.dataMax, l[0], v), v))); else if (g.getExtremes(), v = g.dataMax, g = g.dataMin, k(g) && k(v) && (a.dataMin = Math.min(z(a.dataMin, g), g), a.dataMax = Math.max(z(a.dataMax,
                                v), v)), k(c) && (a.threshold = c), !l.softThreshold || a.positiveValuesOnly) a.softThreshold = !1
                    }
                })
            },
            translate: function (a, b, c, l, f, h) {
                var g = this.linkedParent || this, v = 1, d = 0, r = l ? g.oldTransA : g.transA;
                l = l ? g.oldMin : g.min;
            ...
            getPlotLinePath: function (a, b, c, l, f) {
                var g = this.chart, v = this.left, h = this.top, d, r, e = c && g.oldChartHeight || g.chartHeight,
                    u = c && g.oldChartWidth || g.chartWidth, n;
                d = this.transB;
                var y = function (a, g, b) {
                    if (a < g || a > b) l ? a = Math.min(Math.max(g, a), b) : n = !0;
                    return a
                };
                ...
                q(f) ? this.horiz ?
                    (d = h, r = e - this.bottom, a = c = y(a, v, v + this.width)) : (a = v, c = u - this.right, d = r = y(d, h, h + this.height)) : (n = !0, l = !1);
                return n && !l ? null : g.renderer.crispLine(["M", a, d, "L", c, r], b || 1)
            },
            getLinearTickPositions: function (a, b, c) {
                var g, v = m(Math.floor(b / a) * a);
                c = m(Math.ceil(c / a) * a);
                var f = [], h;
                m(v + a) === v && (h = 20);
            ...
            getMinorTickInterval: function () {
                var a = this.options;
                return !0 === a.minorTicks ? z(a.minorTickInterval, "auto") : !1 === a.minorTicks ?
                    null : a.minorTickInterval
            },
            getMinorTickPositions: function () {
                var a = this, b = a.options, c = a.tickPositions, l = a.minorTickInterval, f = [],
                    h = a.pointRangePadding || 0, d = a.min - h, h = a.max + h, r = h - d;
                if (r && r / l < a.len / 3) if (a.isLog) n(this.paddedTicks, function (g, b, c) {
                    b && f.push.apply(f, a.getLogTickPositions(l, c[b - 1], c[b], !0))
                }); else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) f = f.concat(a.getTimeTicks(a.normalizeTimeTickInterval(l), d, h, b.startOfWeek)); else for (b = d + (c[0] - d) % l; b <= h && b !== f[0]; b += l) f.push(b);
                0 !==
                f.length && a.trimTicks(f);
                return f
            },
            adjustForMinRange: function () {
                var a = this.options, b = this.min, c = this.max, l, f, h, d, r, q, e, u;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (k(a.min) || k(a.max) ? this.minRange = null : (n(this.series, function (a) {
                    q = a.xData;
                    for (d = e = a.xIncrement ? 1 : q.length - 1; 0 < d; d--) if (r = q[d] - q[d - 1], void 0 === h || r < h) h = r
                }), this.minRange = Math.min(5 * h, this.dataMax - this.dataMin)));
                c - b < this.minRange && (f = this.dataMax - this.dataMin >= this.minRange, u = this.minRange, l = (u - c + b) / 2, l = [b - l, z(a.min, b - l)], f && (l[2] =
                    this.isLog ? this.log2lin(this.dataMin) : this.dataMin), b = C(l), c = [b + u, z(a.max, b + u)], f && (c[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax), c = p(c), c - b < u && (l[0] = c - u, l[1] = z(a.min, c - u), b = C(l)));
                this.min = b;
                this.max = c
            },
            getClosest: function () {
                ...
                this.categories ? a = 1 : n(this.series, function (g) {
                    var b = g.closestPointRange, l = g.visible || !g.chart.options.chart.ignoreHiddenSeries;
                    !g.noSharedTooltip && k(b) && l && (a = k(a) ? Math.min(a, b) : b)
                });
                return a
            },
            nameToX: function (a) {
                var g = u(this.categories), c = g ? this.categories :
                    this.names, l = a.options.x, f;
            ...
            setAxisTranslation: function (a) {
                var g = this, b = g.max - g.min, l = g.axisPointRange || 0, c, f = 0, h = 0, d = g.linkedParent,
                    r = !!g.categories, q = g.transA, u = g.isXAxis;
                if (u || r || l) c = g.getClosest(), d ? (f = d.minPointOffset, h = d.pointRangePadding) : n(g.series, function (a) {
                    var b = r ? 1 : u ? z(a.options.pointRange, c, 0) : g.axisPointRange || 0;
                    a = a.options.pointPlacement;
                    l = Math.max(l, b);
                    g.single || (f = Math.max(f, H(a) ? 0 : b / 2), h = Math.max(h, "on" ===
                    a ? 0 : b))
            ...
            setTickInterval: function (g) {
                var b = this, c = b.chart, l = b.options, f = b.isLog, r = b.log2lin, u = b.isDatetimeAxis,
                    e = b.isXAxis, y = b.isLinked, G = l.maxPadding, B = l.minPadding,
                    F = l.tickInterval, H = l.tickPixelInterval, A = b.categories, I = b.threshold, t = b.softThreshold,
                    p, w, M, x;
                ...
                f && (b.positiveValuesOnly && !g && 0 >= Math.min(b.min, z(b.dataMin,
                    b.min)) && a.error(10, 1), b.min = m(r(b.min), 15), b.max = m(r(b.max), 15));
                ...
                u || f || F || (b.tickInterval = D(b.tickInterval, null, h(b.tickInterval), z(l.allowDecimals, !(.5 < b.tickInterval && 5 > b.tickInterval && 1E3 < b.max &&
            ...
            setTickPositions: function () {
                ...
                var l = a.tickPositioner, f = a.startOnTick, h = a.endOnTick;
                this.tickmarkOffset = this.categories && "between" === a.tickmarkPlacement && 1 === this.tickInterval ? .5 : 0;
                this.minorTickInterval = "auto" === b && this.tickInterval ? this.tickInterval / 5 : b;
                this.single = this.min === this.max && k(this.min) && !this.tickAmount && (parseInt(this.min,
            ...
            alignToOthers: function () {
                ...
                !1 === this.chart.options.chart.alignTicks || !1 === c.alignTicks || this.isLog || n(this.chart[this.coll], function (g) {
                    var l = g.options, l = [g.horiz ? l.left : l.top, l.width, l.height, l.pane].join();
            ...
            adjustTickAmount: function () {
                var a = this.tickInterval, b = this.tickPositions, c = this.tickAmount, l = this.finalTickAmt,
                    f = b && b.length, h = z(this.threshold, this.softThreshold ? 0 : null);
                if (this.hasData()) {
                    if (f < c) {
                        for (; b.length < c;) b.length % 2 || this.min === h ? b.push(m(b[b.length - 1] + a)) : b.unshift(m(b[0] - a));
                        this.transA *= (f - 1) / (c - 1);
                        this.min = b[0];
                        this.max = b[b.length - 1]
                    } else f > c && (this.tickInterval *= 2, this.setTickPositions());
                    if (k(l)) {
                        for (a = c = b.length; a--;) (3 === l && 1 === a % 2 || 2 >= l && 0 < a && a < c - 1) && b.splice(a,
                            1);
            ...
            zoom: function (a, b) {
                var g = this.dataMin, l = this.dataMax, c = this.options, f = Math.min(g, z(c.min, g)), c = Math.max(l,
                    z(c.max, l));
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (k(g) && (a < f && (a = f), a > c && (a = c)), k(l) && (b < f && (b = f), b > c && (b = c))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {trigger: "zoom"});
                return !0
            },
            setAxisSize: function () {
                var b = this.chart, c = this.options, f = c.offsets || [0, 0, 0, 0], l = this.horiz,
                    ...
                    r = this.top =
                        Math.round(a.relativeLength(z(c.top, b.plotTop + f[0]), b.plotHeight, b.plotTop)),
            ...
            getThreshold: function (a) {
                var b =
                    this.isLog, g = this.lin2log, l = b ? g(this.min) : this.min, b = b ? g(this.max) : this.max;
            ...
            tickSize: function (a) {
                var b = this.options, g = b[a + "Length"], l = z(b[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
                if (l && g) return "inside" === b[a + "Position"] && (g = -g), [g, l]
            },
            ...
            unsquish: function () {
                var a = this.options.labels, b = this.horiz, c = this.tickInterval, l = c,
                    f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / c), h, d = a.rotation,
                    r = this.labelMetrics(), q, u = Number.MAX_VALUE, e, y = function (a) {
                        a /= f || 1;
                        a = 1 < a ? Math.ceil(a) : 1;
                        return a * c
                    };
                b ? (e = !a.staggerLines && !a.step && (k(d) ? [d] : f < z(a.autoRotationLimit, 80) && a.autoRotation)) && n(e, function (a) {
                    var b;
                    if (a === d || a && -90 <= a && 90 >= a) q = y(Math.abs(r.h / Math.sin(w * a))), b = q +
                        Math.abs(a / 360), b < u && (u = b, h = a, l = q)
                }) : a.step || (l = y(r.h));
                this.autoRotation = e;
            ...
            renderUnsquish: function () {
                var a = this.chart, b = a.renderer, c = this.tickPositions, l = this.ticks,
                    f = this.options.labels, h = this.horiz, d = this.getSlotWidth(),
                    r = Math.max(1, Math.round(d - 2 * (f.padding || 5))), q = {}, u = this.labelMetrics(),
                    e = f.style && f.style.textOverflow, y, k, m = 0, G;
                H(f.rotation) || (q.rotation = f.rotation || 0);
                n(c, function (a) {
                    (a = l[a]) && a.label && a.label.textPxLength > m && (m = a.label.textPxLength)
                });
                this.maxLabelLength = m;
                if (this.autoRotation) m > r && m > u.h ? q.rotation = this.labelRotation : this.labelRotation = 0; else if (d && (y = r, !e)) for (k = "clip", r = c.length; !h && r--;) if (G = c[r], G = l[G].label) G.styles && "ellipsis" ===
                G.styles.textOverflow ? G.css({textOverflow: "clip"}) : G.textPxLength > d && G.css({width: d + "px"}), G.getBBox().height > this.len / c.length - (u.h - u.f) && (G.specificTextOverflow = "ellipsis");
                q.rotation && (y = m > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight, e || (k = "ellipsis"));
                if (this.labelAlign = f.align || this.autoLabelAlign(this.labelRotation)) q.align = this.labelAlign;
                n(c, function (a) {
                    var b = (a = l[a]) && a.label;
                    b && (b.attr(q), !y || f.style && f.style.width || !(y < b.textPxLength || "SPAN" === b.element.tagName) || b.css({
                        width: y, textOverflow: b.specificTextOverflow ||
                        k
            ...
            addTitle: function (a) {
                var b = this.chart.renderer, g = this.horiz, l = this.opposite, c = this.options.title, f;
                this.axisTitle || ((f = c.textAlign) || (f = (g ? {
                    low: "left",
                    middle: "center",
                    high: "right"
                } : {low: l ? "right" : "left", middle: "center", high: l ? "left" : "right"})[c.align]),
            ...
            getOffset: function () {
                var a = this, b = a.chart, c = b.renderer, l = a.options, f = a.tickPositions, h = a.ticks, d = a.horiz,
                    r = a.side, q = b.inverted && !a.isZAxis ? [1, 0, 3, 2][r] : r, u, e, y = 0, m, G = 0, B = l.title,
                    D = l.labels, H = 0, I = b.axisOffset, b = b.clipOffset, A = [-1, 1, 1, -1][r], t = l.className,
                    p = a.axisParent, w = this.tickSize("tick");
                u = a.hasData();
                a.showAxis = e = u || z(l.showEmpty, !0);
                a.staggerLines = a.horiz && D.staggerLines;
                a.axisGroup || (a.gridGroup = c.g("grid").attr({zIndex: l.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (t || "")).add(p), a.axisGroup = c.g("axis").attr({zIndex: l.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (t || "")).add(p), a.labelGroup = c.g("axis-labels").attr({
                    zIndex: D.zIndex ||
                    7
                }).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (t || "")).add(p));
                ...
                B && B.text && !1 !== B.enabled && (a.addTitle(e),
                e && !1 !== B.reserveSpace && (a.titleOffset = y = a.axisTitle.getBBox()[d ? "height" : "width"], m = B.offset, G = k(m) ? 0 : z(B.margin, d ? 5 : 10)));
                a.renderLine();
            ...
            getLinePath: function (a) {
                var b = this.chart, g = this.opposite, l = this.offset, c = this.horiz,
            ...
            getTitlePosition: function () {
                var a = this.horiz, b = this.left, c = this.top,
                    l = this.len, f = this.options.title, h = a ? b : c, r = this.opposite, d = this.offset,
                    q = f.x || 0, u = f.y || 0, e = this.axisTitle,
                    n = this.chart.renderer.fontMetrics(f.style && f.style.fontSize, e),
                    e = Math.max(e.getBBox(null, 0).height - n.h - 1, 0),
                    l = {low: h + (a ? 0 : l), middle: h + l / 2, high: h + (a ? l : 0)}[f.align],
            ...
            renderMinorTick: function (a) {
                var b = this.chart.hasRendered && q(this.oldMin), g =
                    this.minorTicks;
            ...
            renderTick: function (a, b) {
                var g = this.isLinked, l = this.ticks, c = this.chart.hasRendered && q(this.oldMin);
                if (!g || a >= this.min && a <= this.max) l[a] || (l[a] = new B(this, a)), c && l[a].isNew && l[a].render(b, !0, .1), l[a].render(b)
            },
            render: function () {
                var b = this, c = b.chart, f = b.options, l = b.isLog, h = b.lin2log, r = b.isLinked,
                    d = b.tickPositions, u = b.axisTitle, e = b.ticks, y = b.minorTicks, k = b.alternateBands,
                    m = f.stackLabels, D =
                        f.alternateGridColor, H = b.tickmarkOffset, z = b.axisLine, I = b.showAxis,
                    A = E(c.renderer.globalAnimation), t, p;
                ...
                if (b.hasData() || r) b.minorTickInterval && !b.categories && n(b.getMinorTickPositions(), function (a) {
                    b.renderMinorTick(a)
                    ...
                    0 === f %
                    2 && g < b.max && p <= b.max + (c.polar ? -H : H) && (k[g] || (k[g] = new a.PlotLineOrBand(b)), t = g + H, k[g].options = {
                        from: l ? h(t) : t,
                        to: l ? h(p) : p,
                        color: D
            ...
            destroy: function (a) {
                var c = this, g = c.stacks, l = c.plotLinesAndBands, f;
                a || r(c);
                F(g, function (a, b) {
                    t(a);
                    g[b] = null
                ...
                for (f in c.plotLinesAndBandsGroups) c.plotLinesAndBandsGroups[f] = c.plotLinesAndBandsGroups[f].destroy();
                F(c, function (a, l) {
            ...
            drawCrosshair: function (a,
                                     b) {
                var c, l = this.crosshair, g = z(l.snap, !0), f, h = this.cross;
                ...
                this.crosshair && !1 !== (k(b) || !g) ? (g ? k(b) && (f = this.isXAxis ? b.plotX : this.len - b.plotY) : f = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), k(f) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : z(b.stackY, b.y)), null, null, null, f) || null), k(c) ? (b = this.categories && !this.isRadial, h || (this.cross = h = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " : "thin ") + l.className).attr({
                    zIndex: z(l.zIndex,
                        2)
                }).add()), h.show().attr({d: c}), b && !l.width && h.attr({"stroke-width": this.transA}), this.cross.e = a) : this.hideCrosshair()) : this.hideCrosshair()
            },
    ...
    (function (a) {
        var x = a.Axis, E = a.getMagnitude, C = a.normalizeTickInterval, p = a.timeUnits;
        x.prototype.getTimeTicks = function () {
            return this.chart.time.getTimeTicks.apply(this.chart.time, arguments)
        };
        x.prototype.normalizeTimeTickInterval = function (a, e) {
            var k = e || [["millisecond", [1, 2, 5, 10, 20, 25,
                50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]];
            e = k[k.length - 1];
            var m = p[e[0]], t = e[1], n;
    ...
    (function (a) {
        var x = a.Axis, E = a.getMagnitude, C = a.map, p = a.normalizeTickInterval,
            m = a.pick;
        x.prototype.getLogTickPositions = function (a, k, w, t) {
            var e = this.options, c = this.len, d = this.lin2log, A = this.log2lin, h = [];
            t || (this._minorAutoInterval = null);
            if (.5 <= a) a = Math.round(a), h = this.getLinearTickPositions(a, k, w); else if (.08 <= a) for (var c = Math.floor(k), f, b, u, q, H, e = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; c < w + 1 && !H; c++) for (b = e.length, f = 0; f < b && !H; f++) u = A(d(c) * e[f]), u > k && (!t || q <= w) && void 0 !== q && h.push(q), q > w && (H = !0), q = u; else k = d(k), w = d(w), a = t ? this.getMinorTickInterval() : e.tickInterval,
                a = m("auto" === a ? null : a, this._minorAutoInterval, e.tickPixelInterval / (t ? 5 : 1) * (w - k) / ((t ? c / this.tickPositions.length : c) || 1)), a = p(a, null, E(a)), h = C(this.getLinearTickPositions(a, k, w), A), t || (this._minorAutoInterval = a / 5);
    ...
    (function (a, x) {
        var E = a.arrayMax, C = a.arrayMin, p = a.defined, m = a.destroyObjectProperties, e = a.each, k = a.erase,
            w = a.merge, t = a.pick;
        a.PlotLineOrBand =
            function (a, c) {
                this.axis = a;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var e = this, c = e.axis, d = c.horiz, k = e.options, h = k.label, f = e.label, b = k.to, u = k.from,
                    q = k.value, m = p(u) && p(b), M = p(q), D = e.svgElem, F = !D, z = [], r = t(k.zIndex, 0),
                    y = k.events, z = {"class": "highcharts-plot-" + (m ? "band " : "line ") + (k.className || "")},
                    G = {}, B = c.chart.renderer, I = m ? "bands" : "lines", g;
                g = c.log2lin;
                c.isLog && (u = g(u), b = g(b), q = g(q));
                G.zIndex = r;
                I += "-" + r;
                (g = c.plotLinesAndBandsGroups[I]) || (c.plotLinesAndBandsGroups[I] =
                    g = B.g("plot-" + I).attr(G).add());
                F && (e.svgElem = D = B.path().attr(z).add(g));
                if (M) z = c.getPlotLinePath(q, D.strokeWidth()); else if (m) z = c.getPlotBandPath(u, b, k); else return;
                ...
                var h = this.label, f = this.axis.chart.renderer;
                h || (h = {
                ...
                d = C(e);
                f = C(c);
                h.align(a, !1, {x: d, y: f, width: E(e) - d, height: E(c) - f});
                h.show()
            }, destroy: function () {
                k(this.axis.plotLinesAndBands,
                    this);
                delete this.axis;
                m(this)
            }
        ...
        a.extend(x.prototype, {
            getPlotBandPath: function (a, c) {
                var d = this.getPlotLinePath(c, null, null, !0), e = this.getPlotLinePath(a, null, null, !0), h = [],
                    f = this.horiz, b = 1, u;
                a = a < this.min && c < this.min || a > this.max && c > this.max;
                if (e && d) for (a && (u = e.toString() === d.toString(), b = 0), a = 0; a < e.length; a += 6) f && d[a + 1] === e[a + 1] ? (d[a + 1] += b, d[a + 4] += b) : f || d[a + 2] !== e[a + 2] || (d[a + 2] += b, d[a + 5] += b), h.push("M", e[a + 1], e[a + 2], "L", e[a + 4], e[a + 5], d[a + 4], d[a + 5], d[a + 1], d[a + 2], "z"), h.flat = u;
                return h
                ...
                for (var c = this.plotLinesAndBands, d = this.options, m = this.userOptions, h = c.length; h--;) c[h].id === a && c[h].destroy();
                e([d.plotLines || [], m.plotLines || [], d.plotBands || [], m.plotBands || []], function (c) {
                    for (h = c.length; h--;) c[h].id ===
                    a && k(c, c[h])
                })
    ...
    (function (a) {
        var x = a.each, E = a.extend, C = a.format, p = a.isNumber, m = a.map, e = a.merge, k = a.pick, w = a.splat,
            t = a.syncTimeout, n = a.timeUnits;
        a.Tooltip = function () {
            this.init.apply(this, arguments)
        };
        a.Tooltip.prototype = {
            ...
            update: function (a) {
                ...
                var c, h = this.chart, f = h.inverted, b = h.plotTop, e = h.plotLeft, q = 0, k =
                    0, n, D;
                a = w(a);
                c = a[0].tooltipPos;
                ...
                var c = this.chart, f = this.distance, b = {}, u = c.inverted &&
                    e.h || 0, q, m = ["y", c.chartHeight, d, e.plotY + c.plotTop, c.plotTop, c.plotTop + c.plotHeight],
                    ...
                    F = function (a, c, h, g, d, r) {
                        var l = h < g - f, e = g + f + h < c, q = g - f - h;
                        g += f;
                        if (D && e) b[a] = g; else if (!D && l) b[a] = q; else if (l) b[a] = Math.min(r - h, 0 > q - u ? q : q - u); else if (e) b[a] = Math.max(d, g + u + h > c ? g : g + u); else return !1
                    }, z = function (a, c, h, g) {
                        var d;
                ...
                var c, h = this.options, f = a, b, e = {}, q = [];
                c = h.formatter || this.defaultFormatter;
                var e = this.shared, m;
                h.enabled && (clearTimeout(this.hideTimer),
                    this.followPointer = w(f)[0].series.tooltipOptions.followPointer, b = this.getAnchor(f, d), d = b[0], h = b[1], !e || f.series && f.series.noSharedTooltip ? e = f.getLabelConfig() : (x(f, function (a) {
                    a.setState("hover");
                    q.push(a.getLabelConfig())
                }), e = {
                    x: f[0].category,
                    y: f[0].y
                }, e.points = q, f = f[0]), this.len = q.length, e = c.call(e, this), m = f.series, this.distance = k(m.tooltipOptions.distance, 16), !1 === e ? this.hide() : (c = this.getLabel(), this.isHidden && c.attr({opacity: 1}).show(), this.split ? this.renderSplit(e, w(a)) : (c.css({width: this.chart.spacingBox.width}),
                    c.attr({text: e && e.join ? e.join("") : e}), c.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + k(f.colorIndex, m.colorIndex)), this.updatePosition({
                    plotX: d,
                    plotY: h,
                    negative: f.negative,
                    ttBelow: f.ttBelow,
                ...
                var e = this, h = [], f = this.chart, b = f.renderer, u = !0, q = this.options, m = 0,
                    n = this.getLabel();
                a.isString(c) && (c = [!1, c]);
                x(c.slice(0, d.length + 1), function (a, c) {
                    if (!1 !== a) {
                        c = d[c - 1] || {isHeader: !0, plotX: d[0].plotX};
                        var z = c.series || e, r = z.tt, y = "highcharts-color-" +
                            k(c.colorIndex, (c.series || {}).colorIndex, "none");
                ...
                var c = this.chart.time, b = c.dateFormat("%m-%d %H:%M:%S.%L", d), u, q,
                    k = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, m = "millisecond";
                for (q in n) {
                    ...
                    if (k[q] && b.substr(k[q]) !== "01-01 00:00:00.000".substr(k[q])) break;
                    "week" !== q && (m = q)
                }
                q &&
                (u = h[q]);
                ...
                d = d ? "footer" : "header";
                var c = a.series, h = c.tooltipOptions, f = h.xDateFormat, b = c.xAxis,
                    e = b && "datetime" === b.options.type && p(a.key), q = h[d + "Format"];
                e && !f && (f = this.getXDateFormat(a, h, b));
                e && f && x(a.point && a.point.tooltipDateKeys || ["key"], function (a) {
                    q = q.replace("{point." + a + "}", "{point." +
                        a + ":" + f + "}")
                });
                return C(q, {point: a, series: c}, this.chart.time)
    ...
    (function (a) {
        var x = a.addEvent, E = a.attr, C = a.charts, p = a.css, m = a.defined, e = a.each, k = a.extend, w = a.find,
            t = a.fireEvent, n = a.isNumber, c = a.isObject, d = a.offset, A = a.pick, h = a.splat, f = a.Tooltip;
        ...
        a.Pointer.prototype = {
            init: function (a, c) {
                ...
                return k(a, {chartX: Math.round(b.pageX - c.left), chartY: Math.round(b.pageY - c.top)})
                ...
                e(a, function (a) {
                    ...
                    a = a.searchPoint(h, d);
                    if ((d = c(a, !0)) && !(d = !c(b, !0))) var d = b.distX - a.distX, e = b.dist - a.dist,
                ...
                var b = a.series, f = b.xAxis, b = b.yAxis, h =
                    A(a.clientX, a.plotX);
                if (f && b) return c ? {
                    chartX: f.len + f.pos - h,
                    chartY: b.len + b.pos - a.plotY
                } : {chartX: h + f.pos, chartY: a.plotY + b.pos}
            }, getHoverData: function (b, f, h, d, k, m, n) {
                var q, r = [], u = n && n.isBoosting;
                d = !(!d || !b);
                ...
                q && (k && !f.noSharedTooltip ? (n = a.grep(h, function (a) {
                    return a.visible && !(!k && a.directTouch) && A(a.options.enableMouseTracking,
                        !0) && !a.noSharedTooltip
                }), e(n, function (a) {
                ...
                return {hoverPoint: q, hoverSeries: f, hoverPoints: r}
            }, runPointActions: function (b, c) {
                var f = this.chart, h = f.tooltip && f.tooltip.options.enabled ? f.tooltip : void 0,
                    d = h ? h.shared : !1, u = c || f.hoverPoint, k = u && u.series || f.hoverSeries,
                ...
                if (u && (u !== f.hoverPoint || h && h.isHidden)) {
                    ...
                    f.hoverPoint = u;
                    h && h.refresh(d ? m : u, b)
                } else c && h && !h.isHidden && (u = h.getAnchor([{}], b), h.updatePosition({
                    plotX: u[0],
                    plotY: u[1]
                }));
                ...
                e(f.axes, function (c) {
                    var f = A(c.crosshair.snap, !0), h = f ? a.find(m, function (a) {
                        return a.series[c.coll] === c
                    }) : void 0;
                    h || !f ? c.drawCrosshair(b, h) : c.hideCrosshair()
                })
            }, reset: function (a, c) {
                var b = this.chart, f = b.hoverSeries, d = b.hoverPoint, u = b.hoverPoints, k = b.tooltip,
                    m = k && k.shared ? u : d;
                a && m && e(h(m), function (b) {
                    b.series.isCartesian && void 0 === b.plotX &&
                    (a = !1)
                });
                if (a) k && m && (k.refresh(m), d && (d.setState(d.state, !0), e(b.axes, function (a) {
                ...
                e(b.series, function (h) {
                    ...
                    h.markerGroup && (h.markerGroup.attr(f), h.markerGroup.clip(c ? b.clipRect : null)), h.dataLabelsGroup && h.dataLabelsGroup.attr(f))
                });
                ...
                var b = this.chart, c = b.options.chart, f = a.chartX, h = a.chartY, d = this.zoomHor,
                    e = this.zoomVert, k = b.plotLeft, r = b.plotTop, m = b.plotWidth, n = b.plotHeight, B,
                    I = this.selectionMarker, g = this.mouseDownX,
                ...
                I && I.touch || (f < k ? f = k : f > k + m && (f = k + m), h < r ? h = r : h > r + n && (h = r + n), this.hasDragged = Math.sqrt(Math.pow(g - f, 2) + Math.pow(v - h, 2)), 10 < this.hasDragged && (B = b.isInsidePlot(g - k, v - r), b.hasCartesianSeries && (this.zoomX || this.zoomY) && B && !t && !I && (this.selectionMarker = I = b.renderer.rect(k, r, d ? 1 : m, e ? 1 : n, 0).attr({
                    ...
                    width: Math.abs(f),
                    x: (0 < f ? 0 : f) + g
                })), I && e && (f = h - v, I.attr({height: Math.abs(f), y: (0 < f ? 0 : f) + v})),
                B && !I && c.panning && b.pan(a, c.panning)))
            }, drop: function (a) {
                var b = this, c = this.chart, f = this.hasPinched;
                if (this.selectionMarker) {
                    var h = {originalEvent: a, xAxis: [], yAxis: []}, d = this.selectionMarker,
                        F = d.attr ? d.attr("x") : d.x, z = d.attr ? d.attr("y") : d.y,
                        r = d.attr ? d.attr("width") : d.width, y = d.attr ? d.attr("height") : d.height, G;
                    if (this.hasDragged || f) e(c.axes, function (c) {
                        if (c.zoomEnabled && m(c.min) && (f || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                            var d = c.horiz, g = "touchend" === a.type ? c.minPixelPadding : 0,
                                e = c.toValue((d ? F : z) +
                                    g), d = c.toValue((d ? F + r : z + y) - g);
                            h[c.coll].push({axis: c, min: Math.min(e, d), max: Math.max(e, d)});
                            G = !0
                        }
                ...
                var b = this.chart, c = b.hoverPoint, f = b.plotLeft, h = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (t(c.series, "click", k(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (k(a, this.getCoordinates(a)),
                b.isInsidePlot(a.chartX - f, a.chartY - h) && t(b, "click", a)))
    ...
    (function (a) {
        var x =
            a.charts, E = a.each, C = a.extend, p = a.map, m = a.noop, e = a.pick;
        C(a.Pointer.prototype, {
            pinchTranslate: function (a, e, m, n, c, d) {
                ...
                var f = this.chart, b = a ? "x" : "y", k = a ? "X" : "Y", q = "chart" + k, t = a ? "width" : "height",
                    w = f["plot" + (a ? "Left" : "Top")], D, F, z = h || 1, r = f.inverted, y = f.bounds[a ? "h" : "v"],
                    G = 1 === e.length, B = e[0][q], I = m[0][q], g = !G && e[1][q], v = !G && m[1][q], L;
                m =
                    function () {
                ...
                var k = this, t = k.chart, n = k.pinchDown, c = a.touches, d = c.length, A = k.lastValidTouch,
                    h = k.hasZoom, f = k.selectionMarker, b = {}, u = 1 === d && (k.inClass(a.target,
                    "highcharts-tracker") && t.runTrackerClick || k.runChartClick), q = {};
                1 < d && (k.initiated = !0);
                ...
                "touchstart" === a.type ? (E(c, function (a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b = t.bounds[a.horiz ? "h" : "v"], c = a.minPixelPadding,
                            f = a.toPixels(e(a.options.min, a.dataMin)), h = a.toPixels(e(a.options.max, a.dataMax)),
                            d = Math.max(f,
                                h);
                ...
                1 === k.touches.length ? (k = this.normalize(k),
                    (c = p.isInsidePlot(k.chartX - p.plotLeft, k.chartY - p.plotTop)) && !p.openMenu ? (m && this.runPointActions(k), "touchmove" === k.type && (m = this.pinchDown, n = m[0] ? 4 <= Math.sqrt(Math.pow(m[0].chartX - k.chartX, 2) + Math.pow(m[0].chartY - k.chartY, 2)) : !1), e(n, !0) && this.pinch(k)) : m && this.reset()) : 2 === k.touches.length && this.pinch(k)
    ...
    (function (a) {
        var x = a.addEvent, E = a.charts, C = a.css, p = a.doc, m = a.extend, e = a.noop, k = a.Pointer,
            w = a.removeEvent, t = a.win, n = a.wrap;
        if (!a.hasTouch && (t.PointerEvent || t.MSPointerEvent)) {
            var c = {}, d = !!t.PointerEvent, A = function () {
                var f = [];
                f.item = function (a) {
                    return this[a]
                };
                a.objectEach(c, function (a) {
                    f.push({pageX: a.pageX, pageY: a.pageY, target: a.target})
                });
                return f
            }, h = function (c, b, h, d) {
                "touch" !== c.pointerType && c.pointerType !== c.MSPOINTER_TYPE_TOUCH || !E[a.hoverChartIndex] || (d(c), d = E[a.hoverChartIndex].pointer, d[b]({
                    type: h,
                    target: c.currentTarget, preventDefault: e, touches: A()
                }))
            };
            m(k.prototype, {
    ...
    (function (a) {
        var x = a.addEvent, E = a.css, C = a.discardElement, p = a.defined, m = a.each, e = a.isFirefox,
            k = a.marginNames, w = a.merge, t = a.pick, n = a.setAnimation, c = a.stableSort, d = a.win, A = a.wrap;
        ...
        a.Legend.prototype = {
            init: function (a, c) {
                ...
                var c = this.options, b = c.symbolPadding, c = !c.rtl, h =
                    a._legendItemPos, d = h[0], h = h[1], e = a.checkbox;
                ...
                b.text && (this.title || (this.title = this.chart.renderer.label(b.text, c - 3, c -
                    4, null, null, null, a.useHTML, null, "legend-title").attr({zIndex: 1}).add(this.group)), a = this.title.getBBox(), d = a.height, this.offsetWidth = a.width, this.contentGroup.attr({translateY: d}));
                this.titleHeight = d
            }, setText: function (c) {
                var f = this.options;
                c.legendItem.attr({text: f.labelFormat ? a.format(f.labelFormat, c, this.chart.time) : f.labelFormatter.call(c)})
            }, renderItem: function (a) {
                var c = this.chart, b = c.renderer, d = this.options, h = "horizontal" === d.layout,
                    e = this.symbolWidth, k = d.symbolPadding, m = this.padding, n = h ? t(d.itemDistance,
                    20) : 0, p = !d.rtl, r = d.width, y = d.itemMarginBottom || 0, G = this.itemMarginTop,
                    B = a.legendItem, I = !a.series, g = !I && a.series.drawLegendSymbol ? a.series : a, v = g.options,
                    L = this.createCheckboxForItem && v && v.showCheckbox, v = e + k + n + (L ? 20 : 0), l = d.useHTML,
                ...
                this.setText(a);
                b = B.getBBox();
                e = a.checkboxOffset = d.itemWidth || a.legendItemWidth || b.width +
                    v;
            ...
            getAllItems: function () {
                ...
                var b = this.chart, f = this.options, d = this.getAlignment();
                d && m([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (h, e) {
                    h.test(d) &&
                    !p(a[e]) && (b[k[e]] = Math.max(b[k[e]], b.legend[(e + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][e] * f[e % 2 ? "x" : "y"] + t(f.margin, 12) + c[e] + (0 === e ? b.titleOffset + b.options.title.margin : 0)))
                })
            }, render: function () {
                var a = this, f = a.chart, b = f.renderer, d = a.group, e, k, n, p, t = a.box, z = a.options,
                    r = a.padding;
                a.itemX = r;
                ...
                var c = this, b = this.chart, d = b.renderer, e = this.options, h = e.y, k = this.padding,
                    b = b.spacingBox.height + ("top" === e.verticalAlign ?
                        -h : h) - k, h = e.maxHeight, n, p = this.clipRect, z = e.navigation, r = t(z.animation, !0),
                    y = z.arrowSize || 12, G = this.nav, B = this.pages, I, g = this.allItems, v = function (a) {
                ...
                h && (b = Math.min(b, h));
                B.length = 0;
                a > b && !1 !== z.enabled ? (this.clipHeight = n = Math.max(b - 20 - this.titleHeight -
                    k, 0), this.currentPage = t(this.currentPage, 1), this.fullHeight = a, m(g, function (a, b) {
                    var c = a._legendItemPos[1], l = Math.round(a.legendItem.getBBox().height), f = B.length;
                    if (!f || c - B[f - 1] > n && (I || c) !== B[f - 1]) B.push(I || c), f++;
                    a.pageIx = f - 1;
                    I && (g[b - 1].pageIx = f - 1);
                ...
                var d = this.clipHeight, e = this.pager, h = this.padding;
                a > f && (a = f);
                0 < a && (void 0 !== c && n(c, this.chart), this.nav.attr({
                    translateX: h, translateY: d + this.padding +
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function (a, c) {
                ...
                var c = this.options.marker, b, d = a.symbolWidth, e = a.symbolHeight;
                b = e / 2;
                var h = this.chart.renderer, k = this.legendGroup;
                a = a.baseline - Math.round(.3 * a.fontMetrics.b);
                this.legendLine = h.path(["M", 0, a, "L", d, a]).addClass("highcharts-graph").attr({}).add(k);
                c && !1 !== c.enabled &&
                (b = Math.min(t(c.radius, b), b), 0 === this.symbol.indexOf("url") && (c = w(c, {
                    width: e,
                    height: e
    ...
    (function (a) {
        var x = a.addEvent, E = a.animObject, C = a.attr, p = a.doc, m = a.Axis, e = a.createElement,
            k = a.defaultOptions, w = a.discardElement,
            t = a.charts, n = a.defined, c = a.each, d = a.extend, A = a.find, h = a.fireEvent, f = a.grep,
            b = a.isNumber, u = a.isObject, q = a.isString, H = a.Legend, M = a.marginNames, D = a.merge,
            F = a.objectEach, z = a.Pointer, r = a.pick, y = a.pInt, G = a.removeEvent, B = a.seriesTypes, I = a.splat,
            g = a.syncTimeout, v = a.win, L = a.Chart = function () {
        ...
        d(L.prototype, {
            callbacks: [], getArgs: function () {
                ...
                var l, g, f = b.series, d = b.plotOptions || {};
                b.series = null;
                l = D(k, b);
                for (g in l.plotOptions) l.plotOptions[g].tooltip = d[g] && D(d[g].tooltip) || void 0;
                ...
                var g = this.axes, l = this.series, f = this.pointer, e = this.legend, r = this.isDirtyLegend, k, m,
                    y = this.hasCartesianSeries, n = this.isDirtyBox, q, G = this.renderer, u = G.isHidden(), B = [];
                this.setResponsive && this.setResponsive(!1);
                a.setAnimation(b, this);
                u && this.temporaryDisplay();
                this.layOutTitles();
                for (b = l.length; b--;) if (q = l[b], q.options.stacking && (k = !0, q.isDirty)) {
                    m = !0;
                    break
                }
                if (m) for (b = l.length; b--;) q = l[b], q.options.stacking &&
                (q.isDirty = !0);
                c(l, function (a) {
                ...
                for (l = 0; !c && l < g.length; l++) c = A(g[l].points || [], b);
                return c
            }, getAxes: function () {
                var a = this, b = this.options, g = b.xAxis = I(b.xAxis ||
                    {}), b = b.yAxis = I(b.yAxis || {});
                ...
                var l = this, f = l.options, d;
                d = f.title = D(f.title, a);
                f = f.subtitle = D(f.subtitle, b);
                c([["title", a, d],
                    ["subtitle", b, f]], function (a, b) {
                    var c = a[0], g = l[c], f = a[1];
                    a = a[2];
                    g && f && (l[c] = g = g.destroy());
                ...
                var b = 0, g, l = this.renderer, f = this.spacingBox;
                c(["title", "subtitle"], function (a) {
                    var c = this[a], g = this.options[a];
                    a = "title" === a ? -3 : g.verticalAlign ? 0 : b + 2;
                    var e;
                    c && (e = l.fontMetrics(e, c).b, c.css({
                        width: (g.width ||
                            f.width + g.widthAdjust) + "px"
                    }).align(d({y: a + e}, g), !1, "spacingBox"), g.floating || g.verticalAlign || (b = Math.ceil(b + c.getBBox(g.useHTML).height)))
                }, this);
                g = this.titleOffset !== b;
                this.titleOffset = b;
                !this.isDirtyBox && g && (this.isDirtyBox = g, this.hasRendered && r(a, !0) && this.isDirtyBox && this.redraw())
            }, getChartSize: function () {
                var b = this.options.chart, c = b.width, b = b.height, g = this.renderTo;
                ...
                var c, g = this.options, f = g.chart, d, h;
                c = this.renderTo;
                var r = a.uniqueKey(), k;
                ...
                var c = this, f = c.options.chart, l = c.renderTo, d = n(f.width) && n(f.height),
                    e = f.width || a.getStyle(l, "width"), f = f.height || a.getStyle(l, "height"),
                    l = b ? b.target : v;
                if (!d && !c.isPrinting && e && f && (l === v || l === p)) {
                    if (e !== c.containerWidth || f !== c.containerHeight) clearTimeout(c.reflowTimeout), c.reflowTimeout = g(function () {
                ...
                var b = this.inverted, g = this.renderer, f = this.chartWidth, l = this.chartHeight,
                    d = this.options.chart, e = this.spacing, h = this.clipOffset, r, k, m, y;
                ...
                this.spacingBox = g.spacingBox = {x: e[3], y: e[0], width: f - e[3] - e[1], height: l - e[0] - e[2]};
                this.plotBox = g.plotBox = {x: r, y: k, width: m, height: y};
                ...
                var a = this.options.chart, b = this.renderer, c = this.chartWidth, g = this.chartHeight,
                    ...
                    d = this.plotBackground, e = this.plotBorder, r, k, m = this.plotLeft, y = this.plotTop,
                    n = this.plotWidth, q = this.plotHeight, G = this.plotBox, u = this.clipRect, B = this.clipBox,
                    v = "animate";
                f || (this.chartBackground = f = b.rect().addClass("highcharts-background").add(), v = "attr");
                r = k = f.strokeWidth();
                f[v]({x: k / 2, y: k / 2, width: c - k - r % 2, height: g - k - r % 2, r: a.borderRadius});
                v = "animate";
                d || (v = "attr", this.plotBackground = d = b.rect().addClass("highcharts-plot-background").add());
                d[v](G);
                u ? u.animate({width: B.width, height: B.height}) : this.clipRect =
                    b.clipRect(B);
                v = "animate";
                e || (v = "attr", this.plotBorder = e = b.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
                e[v](e.crisp({x: m, y: y, width: n, height: q}, -e.strokeWidth()));
                this.isDirtyBox = !1;
                h(this, "afterDrawChartBox")
            }, propFromSeries: function () {
                var a = this, b = a.options.chart, g, f = a.options.series, d, e;
                c(["inverted", "angular", "polar"], function (c) {
                    g = B[b.type || b.defaultSeriesType];
                    e = b[c] || g && g.prototype[c];
                    for (d = f && f.length; !e && d--;) (g = B[f[d].type]) && g.prototype[c] && (e = !0);
                    a[c] = e
                })
            }, linkSeries: function () {
                var a =
                ...
                b.items && c(b.items, function (c) {
                    var g = d(b.style, c.style), f = y(g.left) + a.plotLeft, l = y(g.top) +
                        a.plotTop + 12;
                    delete g.left;
                    delete g.top;
                ...
                var a = this.axes, b = this.renderer, g = this.options, f, d, e;
                this.setTitle();
                ...
                var b = this, g = b.axes, f = b.series, d = b.container, e, r = d && d.parentNode;
                h(b, "destroy");
    ...
    (function (a) {
        var x, E = a.each, C = a.extend, p = a.erase, m = a.fireEvent,
            e = a.format, k = a.isArray, w = a.isNumber, t = a.pick, n = a.removeEvent;
        a.Point = x = function () {
        };
        a.Point.prototype = {
            init: function (a, d, e) {
                ...
                var c = {}, e = this.series, h = e.options.keys, f = h || e.pointArrayMap || ["y"], b = f.length, m = 0,
                    n = 0;
                if (w(a) ||
                    null === a) c[f[0]] = a; else if (k(a)) for (!h && a.length > b && (e = typeof a[0], "string" === e ? c.name = a[0] : "number" === e && (c.x = a[0]), m++); n < b;) h && void 0 === a[m] || (c[f[n]] = a[m]), m++, n++; else "object" === typeof a && (c = a, a.dataLabels && (e._hasPointLabels = !0), a.marker && (e._hasPointMarkers = !0));
                return c
                ...
                var a = this.series, d = a.zones, a = a.zoneAxis || "y", e = 0, h;
                for (h = d[e]; this[a] >= h.value;) h = d[++e];
                ...
                var c = this.series, k = c.tooltipOptions, h = t(k.valueDecimals, ""), f = k.valuePrefix || "",
                    b = k.valueSuffix || "";
                E(c.pointArrayMap || ["y"], function (c) {
                    c = "{point." + c;
                    if (f || b) a = a.replace(c + "}", f + c + "}" + b);
                    a = a.replace(c + "}", c + ":,." + h + "f}")
                });
    ...
    (function (a) {
        var x = a.addEvent, E = a.animObject, C = a.arrayMax, p = a.arrayMin, m = a.correctFloat, e = a.defaultOptions,
            k = a.defined, w = a.each, t = a.erase, n = a.extend, c = a.fireEvent, d = a.grep, A = a.isArray,
            h = a.isNumber, f = a.isString, b = a.merge, u = a.objectEach, q = a.pick, H = a.removeEvent, M = a.splat,
            D = a.SVGElement, F = a.syncTimeout, z = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            init: function (a, b) {
                ...
                if (f && f.click || b.point && b.point.events && b.point.events.click || b.allowPointSelect) a.runTrackerClick =
                    !0;
                c.getColor();
                c.getSymbol();
            ...
            bindAxes: function () {
                var b = this, c = b.options, f = b.chart, d;
                w(b.axisTypes || [],
                    function (e) {
                        w(f[e], function (a) {
                            d = a.options;
            ...
            updateParallelArrays: function (a, b) {
                var c = a.series, f = arguments, d = h(b) ? function (g) {
            ...
            autoIncrement: function () {
                var a = this.options, b = this.xIncrement,
                    c, f = a.pointIntervalUnit, d = this.chart.time, b = q(b, a.pointStart, 0);
            ...
            setOptions: function (a) {
                var c = this.chart, f = c.options, d = f.plotOptions, h = (c.userOptions || {}).plotOptions || {},
                    g = d[this.type];
                this.userOptions = a;
                c = b(g, d.series, a);
                this.tooltipOptions =
                    b(e.tooltip, e.plotOptions.series && e.plotOptions.series.tooltip, e.plotOptions[this.type].tooltip, f.tooltip.userOptions, d.series && d.series.tooltip, d[this.type].tooltip, a.tooltip);
            ...
            getCyclic: function (a, b, c) {
                var f, d = this.chart, g = this.userOptions, e = a + "Index", h = a + "Counter",
            ...
            setData: function (b, c, d, e) {
                var r = this, g = r.points, k = g && g.length || 0, m, l = r.options, n = r.chart, y = null,
                    u = r.xAxis, p = l.turboThreshold, B = this.xData, z = this.yData,
                    G = (m = r.pointArrayMap) && m.length;
                b = b || [];
                m = b.length;
                c = q(c, !0);
                if (!1 !== e && m && k === m && !r.cropped && !r.hasGroupedData && r.visible) w(b, function (a, b) {
                    ...
                    if (p && m > p) {
                        for (d = 0; null === y && d < m;) y = b[d], d++;
                        if (h(y)) for (d = 0; d < m; d++) B[d] = this.autoIncrement(), z[d] = b[d]; else if (A(y)) if (G) for (d = 0; d < m; d++) y = b[d], B[d] = y[0], z[d] = y.slice(1, G + 1); else for (d = 0; d < m; d++) y = b[d], B[d] = y[0], z[d] = y[1]; else a.error(12)
                    } else for (d = 0; d < m; d++) void 0 !== b[d] && (y = {series: r}, r.pointClass.prototype.applyOptions.apply(y, [b[d]]), r.updateParallelArrays(y, d));
            ...
            processData: function (b) {
                var c = this.xData, f = this.yData, d = c.length, e;
                e = 0;
                var g, h, r = this.xAxis, l, k = this.options;
                l = k.cropThreshold;
                var m = this.getExtremesFromAll || k.getExtremesFromAll, n = this.isCartesian, k = r && r.val2lin,
                    q = r && r.isLog, u = this.requireSorting, p, z;
                if (n && !this.isDirty && !r.isDirty && !this.yAxis.isDirty && !b) return !1;
                r && (b = r.getExtremes(), p = b.min, z = b.max);
                if (n && this.sorted && !m && (!l || d > l || this.forceCrop)) if (c[d - 1] < p || c[0] > z) c = [], f = []; else if (c[0] < p || c[d - 1] > z) e = this.cropData(this.xData, this.yData, p, z), c = e.xData, f = e.yData, e = e.start, g = !0;
                for (l = c.length || 1; --l;) d = q ? k(c[l]) - k(c[l - 1]) : c[l] - c[l - 1], 0 < d && (void 0 === h || d < h) ? h = d : 0 > d && u && (a.error(15), u = !1);
                this.cropped = g;
                this.cropStart = e;
            ...
            cropData: function (a,
                                b, c, f) {
                var d = a.length, g = 0, e = d, h = q(this.cropShoulder, 1), l;
                for (l = 0; l < d; l++) if (a[l] >= c) {
                    g = Math.max(0, l - h);
                    break
                }
                for (c = l; c < d; c++) if (a[c] > f) {
                    e = c + h;
                    break
                }
            ...
            generatePoints: function () {
                var a = this.options, b = a.data, c = this.data, f, d = this.processedXData, g = this.processedYData,
                    e = this.pointClass, h = d.length, l = this.cropStart || 0, k, m = this.hasGroupedData, a = a.keys,
                    n, q = [], u;
                c || m || (c = [], c.length = b.length, c = this.data = c);
                a && m && (this.options.keys = !1);
                for (u = 0; u < h; u++) k =
                    l + u, m ? (n = (new e).init(this, [d[u]].concat(M(g[u]))), n.dataGroup = this.groupMap[u]) : (n = c[k]) || void 0 === b[k] || (c[k] = n = (new e).init(this, b[k], d[u])), n && (n.index = k, q[u] = n);
                this.options.keys = a;
                if (c && (h !== (f = c.length) || m)) for (u = 0; u < f; u++) u !== l || m || (u += h), c[u] && (c[u].destroyElements(), c[u].plotX = void 0);
                this.data = c;
                this.points = q
            },
            getExtremes: function (a) {
                var b = this.yAxis, c = this.processedXData, f, d = [], g = 0;
                f = this.xAxis.getExtremes();
                var e = f.min, r = f.max, l, k, m, n;
                a = a || this.stackedYData || this.processedYData || [];
                f =
                    a.length;
                for (n = 0; n < f; n++) if (k = c[n], m = a[n], l = (h(m, !0) || A(m)) && (!b.positiveValuesOnly || m.length || 0 < m), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[n + 1] || k) >= e && (c[n - 1] || k) <= r, l && k) if (l = m.length) for (; l--;) "number" === typeof m[l] && (d[g++] = m[l]); else d[g++] = m;
                this.dataMin = p(d);
                this.dataMax = C(d)
            },
            translate: function () {
                ...
                this.generatePoints();
                var a = this.options, b = a.stacking, f = this.xAxis, d = f.categories, e = this.yAxis, g = this.points,
                    n = g.length,
                    u = !!this.modifyValue, l = a.pointPlacement, p = "between" === l || h(l), z = a.threshold,
                    t = a.startFromThreshold ? z : 0, F, D, w, A, H = Number.MAX_VALUE;
                "between" === l && (l = .5);
                h(l) && (l *= q(a.pointRange || f.pointRange));
                for (a = 0; a < n; a++) {
                    var x = g[a], M = x.x, C = x.y;
                    D = x.low;
                    var E = b && e.stacks[(this.negStacks && C < (t ? 0 : z) ? "-" : "") + this.stackKey], K;
                    e.positiveValuesOnly && null !== C && 0 >= C && (x.isNull = !0);
                    x.plotX = F = m(Math.min(Math.max(-1E5, f.translate(M, 0, 0, 0, 1, l, "flags" === this.type)), 1E5));
                    b && this.visible && !x.isNull && E && E[M] && (A = this.getStackIndicator(A,
                        M, this.index), K = E[M], C = K.points[A.key], D = C[0], C = C[1], D === t && A.key === E[M].base && (D = q(z, e.min)), e.positiveValuesOnly && 0 >= D && (D = null), x.total = x.stackTotal = K.total, x.percentage = K.total && x.y / K.total * 100, x.stackY = C, K.setOffset(this.pointXOffset || 0, this.barW || 0));
                    ...
                    x.isInside = void 0 !== D && 0 <= D && D <= e.len && 0 <=
                        F && F <= f.len;
            ...
            setClip: function (a) {
                var b = this.chart, c = this.options, f = b.renderer, d = b.inverted, g =
                        this.clipBox, e = g || b.clipBox,
                ...
                (delete l.count[this.index], --l.count.length), 0 === l.count.length && h && b[h] && (g || (b[h] = b[h].destroy()), b[h + "m"] && (b[h + "m"] = b[h + "m"].destroy())))
            },
            animate: function (a) {
                var b = this.chart, c = E(this.options.animation), f;
                a ? this.setClip(c) : (f = this.sharedClipKey, (a = b[f]) && a.animate({
                    width: b.plotSizeX,
                    x: 0
                }, c), b[f + "m"] && b[f + "m"].animate({width: b.plotSizeX + 99, x: 0}, c), this.animate = null)
            },
            ...
            drawPoints: function () {
                var a = this.points,
                    b = this.chart, c, f, d, g, e = this.options.marker, h, l, k,
                    m = this[this.specialGroup] || this.markerGroup, n,
                    u = q(e.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx >= e.enabledThreshold * e.radius);
                if (!1 !== e.enabled || this._hasPointMarkers) for (c = 0; c < a.length; c++) f = a[c], g = f.graphic, h = f.marker || {}, l = !!f.marker, d = u && void 0 === h.enabled || h.enabled, k = f.isInside, d && !f.isNull ? (d = q(h.symbol, this.symbol), n = this.markerAttribs(f, f.selected && "select"), g ? g[k ? "show" : "hide"](!0).animate(n) : k && (0 < n.width || f.hasImage) && (f.graphic =
                    g = b.renderer.symbol(d, n.x, n.y, n.width, n.height, l ? h : e).add(m)), g && g.addClass(f.getClassName(), !0)) : g && (f.graphic = g.destroy())
            },
            markerAttribs: function (a, b) {
                var c = this.options.marker, f = a.marker || {}, d = f.symbol || c.symbol, g = q(f.radius, c.radius);
            ...
            destroy: function () {
                var a = this, b = a.chart,
                    f = /AppleWebKit\/533/.test(z.navigator.userAgent), d, e, g = a.data || [], h, k;
                c(a, "destroy");
                H(a);
            ...
            getGraphPath: function (a, b, c) {
                var f = this, d = f.options, g = d.step, e, h = [], l = [], m;
                a = a || f.points;
                (e = a.reversed) && a.reverse();
                (g = {right: 1, center: 2}[g] || g && 3) && e && (g = 4 - g);
                !d.connectNulls || b || c || (a = this.getValidPoints(a));
                w(a, function (e, r) {
                    var n = e.plotX, q = e.plotY, u = a[r - 1];
                    (e.leftCliff || u && u.rightCliff) && !c && (m = !0);
                    e.isNull && !k(b) && 0 < r ? m = !d.connectNulls : e.isNull && !b ? m = !0 : (0 === r || m ? r = ["M", e.plotX, e.plotY] : f.getPointSpline ? r = f.getPointSpline(a, e, r) : g ? (r = 1 === g ? ["L", u.plotX, q] : 2 === g ? ["L", (u.plotX +
                        n) / 2, u.plotY, "L", (u.plotX + n) / 2, q] : ["L", n, u.plotY], r.push("L", n, q)) : r = ["L", n, q], l.push(e.x), g && l.push(e.x), h.push.apply(h, r), m = !1)
                });
                h.xMap = l;
            ...
            drawGraph: function () {
                ...
                w(c, function (c, f) {
                    f = c[0];
                    var g = a[f];
                    g ? (g.endX = a.preventGraphAnimation ? null : b.xMap, g.animate({d: b})) : b.length &&
                        (a[f] = a.chart.renderer.path(b).addClass(c[1]).attr({zIndex: 1}).add(a.group));
                    g && (g.startX = b.xMap, g.isArea = b.isArea)
                })
            },
            applyZones: function () {
                var a = this, b = this.chart, c = b.renderer, f = this.zones, d, g, e = this.clips || [], h,
                    l = this.graph, k = this.area, m = Math.max(b.chartWidth, b.chartHeight),
                    n = this[(this.zoneAxis || "y") + "Axis"], u, p, z = b.inverted, t, D, F, A, H = !1;
            ...
            plotGroup: function (a, b, c, f, d) {
                ...
                g.addClass("highcharts-" + b + " highcharts-series-" + this.index + " highcharts-" + this.type + "-series " + (k(this.colorIndex) ? "highcharts-color-" + this.colorIndex +
            ...
            render: function () {
                var a = this, b = a.chart, f, d = a.options,
                    e = !!a.animate && b.renderer.isSVG && E(d.animation).duration,
                    g = a.visible ? "inherit" : "hidden", h = d.zIndex,
                    k = a.hasRendered, l = b.seriesGroup, m = b.inverted;
            ...
            redraw: function () {
                var a = this.chart, b = this.isDirty || this.isDirtyData, c = this.group, f = this.xAxis,
                    d = this.yAxis;
                c && (a.inverted && c.attr({
                    width: a.plotWidth,
                    height: a.plotHeight
                }), c.animate({translateX: q(f && f.left, a.plotLeft), translateY: q(d && d.top, a.plotTop)}));
                this.translate();
                this.render();
            ...
            searchPoint: function (a, b) {
                var c = this.xAxis, f = this.yAxis, d = this.chart.inverted;
            ...
            buildKDTree: function () {
                function a(c, f, d) {
                    var g, e;
                    if (e = c && c.length) return g = b.kdAxisArray[f % d], c.sort(function (a, b) {
                        return a[g] - b[g]
                    }), e = Math.floor(e / 2), {
                        point: c[e],
            ...
            searchKDTree: function (a, b) {
                function c(a, b, h, m) {
                    var l = b.point, n = f.kdAxisArray[h % m], r, q, u = l;
                ...
                var f = this, d = this.kdAxisArray[0], g = this.kdAxisArray[1],
                    e = b ? "distX" : "dist";
    ...
    (function (a) {
        var x = a.Axis, E = a.Chart, C = a.correctFloat, p = a.defined, m = a.destroyObjectProperties, e = a.each,
            k = a.format, w = a.objectEach, t = a.pick, n = a.Series;
        ...
        a.StackItem.prototype = {
            destroy: function () {
                ...
                var c = this.axis, e = c.chart, f = c.translate(c.usePercentage ? 100 : this.total, 0, 0, 0, 1),
                    c = c.translate(0), c = Math.abs(f - c);
                a = e.xAxis[0].translate(this.x) + a;
                f = this.getStackBox(e, this, a, f, d, c);
                if (d = this.label) d.align(this.alignOptions, null, f), f = d.alignAttr, d[!1 === this.options.crop || e.isInsidePlot(f.x, f.y) ? "show" : "hide"](!0)
            }, getStackBox: function (a, d, e, h, f, b) {
                var c = d.axis.reversed, k = a.inverted;
                a = a.plotHeight;
                d = d.isNegative && !c || !d.isNegative &&
                    c;
                return {
                    x: k ? d ? h : h - b : e,
        ...
        x.prototype.buildStacks = function () {
            var a = this.series, d = t(this.options.reversedStacks, !0), e = a.length, h;
            if (!this.isXAxis) {
                this.usePercentage = !1;
                for (h = e; h--;) a[d ? h :
                    e - h - 1].setStackedPoints();
                for (h = 0; h < e; h++) a[h].modifyStacks()
            }
        };
        x.prototype.renderStackTotals = function () {
            var a = this.chart, d = a.renderer, e = this.stacks, h = this.stackTotalGroup;
        ...
        x.prototype.resetStacks = function () {
            ...
            a.isXAxis || w(d, function (c) {
                w(c, function (d, f) {
                    d.touched < a.stacksTouched ? (d.destroy(), delete c[f]) :
        ...
        n.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var c = this.processedXData, d = this.processedYData, e = [], h = d.length, f = this.options,
                    b = f.threshold, k = t(f.startFromThreshold && b, 0), m = f.stack, f = f.stacking,
                    n = this.stackKey, w =
                    "-" + n, D = this.negStacks, F = this.yAxis, z = F.stacks, r = F.oldStacks, y, G, B, I, g, v, x;
                F.stacksTouched += 1;
                for (g = 0; g < h; g++) v = c[g], x = d[g], y = this.getStackIndicator(y, v, this.index), I = y.key, B = (G = D && x < (k ? 0 : b)) ? w : n, z[B] || (z[B] = {}), z[B][v] || (r[B] && r[B][v] ? (z[B][v] = r[B][v], z[B][v].total = null) : z[B][v] = new a.StackItem(F, F.options.stackLabels, G, v, m)), B = z[B][v], null !== x ? (B.points[I] = B.points[this.index] = [t(B.cumulative, k)], p(B.cumulative) || (B.base = I), B.touched = F.stacksTouched, 0 < y.index && !1 === this.singleStacks && (B.points[I][0] =
                    B.points[this.index + "," + v + ",0"][0])) : B.points[I] = B.points[this.index] = null, "percent" === f ? (G = G ? n : w, D && z[G] && z[G][v] ? (G = z[G][v], B.total = G.total = Math.max(G.total, B.total) + Math.abs(x) || 0) : B.total = C(B.total + (Math.abs(x) || 0))) : B.total = C(B.total + (x || 0)), B.cumulative = t(B.cumulative, k) + (x || 0), null !== x && (B.points[I].push(B.cumulative), e[g] = B.cumulative);
        ...
        n.prototype.modifyStacks = function () {
            var a = this, d = a.stackKey, k = a.yAxis.stacks, h = a.processedXData,
                f, b = a.options.stacking;
            a[b + "Stacker"] && e([d, "-" + d], function (c) {
                for (var d = h.length, e, m; d--;) if (e = h[d], f = a.getStackIndicator(f, e, a.index, c), m = (e = k[c] && k[c][e]) && e.points[f.key]) a[b + "Stacker"](m, e, d)
            })
        };
        ...
        n.prototype.getStackIndicator = function (a, d, e, h) {
            !p(a) || a.x !== d || h && a.key !== h ? a = {x: d, index: 0, key: h} : a.index++;
    ...
    (function (a) {
        var x = a.addEvent,
            E = a.Axis, C = a.createElement, p = a.css, m = a.defined, e = a.each, k = a.erase, w = a.extend,
            t = a.fireEvent, n = a.inArray, c = a.isNumber, d = a.isObject, A = a.isArray, h = a.merge,
            f = a.objectEach, b = a.pick, u = a.Point, q = a.Series, H = a.seriesTypes, M = a.setAnimation, D = a.splat;
        w(a.Chart.prototype, {
            ...
            addAxis: function (a, c, f, d) {
                var e = c ? "xAxis" : "yAxis", k = this.options;
                a = h(a,
                    {index: this[e].length, isX: c});
                c = new E(this, a);
                k[e] = D(k[e] || {});
                k[e].push(a);
                b(f, !0) && this.redraw(d);
            ...
            update: function (a, d, k) {
                var r = this, q = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, u = a.chart, p,
                    g, t = [];
                if (u) {
                    h(!0, r.options.chart, u);
                    "className" in u && r.setClassName(u.className);
                    if ("inverted" in u || "polar" in u) r.propFromSeries(), p = !0;
                    "alignTicks" in u && (p = !0);
                    f(u, function (a, b) {
                ...
                f(a, function (a, b) {
                    if (r[b] && "function" === typeof r[b].update) r[b].update(a,
                        !1); else if ("function" === typeof r[q[b]]) r[q[b]](a);
                ...
                e("xAxis yAxis zAxis series colorAxis pane".split(" "), function (b) {
                    a[b] && (e(D(a[b]), function (a, c) {
                        ...
                        if (!c && k) if ("series" === b) r.addSeries(a, !1).touched = !0; else if ("xAxis" === b || "yAxis" === b) r.addAxis(a, "xAxis" === b, !1).touched = !0
                    }), k && e(r[b], function (a) {
        ...
        w(u.prototype, {
            update: function (a, c, f, e) {
                function h() {
                    ...
                    d(a, !0) && (g && g.element && a && a.marker && void 0 !== a.marker.symbol && (k.graphic = g.destroy()), a && a.dataLabels &&
                    k.dataLabel && (k.dataLabel = k.dataLabel.destroy()), k.connector && (k.connector = k.connector.destroy()));
                    n = k.index;
                ...
                var k = this, m = k.series, g = k.graphic, n, r = m.chart, l = m.options;
                c = b(c, !0);
                !1 === e ? h() : k.firePointEvent("update", {options: a}, h)
            }, remove: function (a, b) {
                this.series.removePoint(n(this, this.series.data),
                    a, b)
            }
        });
        w(q.prototype, {
            addPoint: function (a, c, f, d) {
                var e = this.options, h = this.data, k = this.chart, g = this.xAxis, g = g && g.hasNames && g.names,
                    m = e.data, n, l, r = this.xData, q, u;
                c = b(c, !0);
                n = {series: this};
                this.pointClass.prototype.applyOptions.apply(n, [a]);
                u = n.x;
                q = r.length;
                if (this.requireSorting && u < r[q - 1]) for (l = !0; q && r[q - 1] > u;) q--;
                ...
                var d = this, e = d.data, h = e[a], k = d.points, g = d.chart, m = function () {
                ...
                M(f, g);
                c = b(c, !0);
                h ? h.firePointEvent("remove", null, m) :
                    m()
                ...
                var f = this, d = f.chart, k = f.userOptions, m = f.oldType || f.type,
                    n = a.type || k.type || d.options.chart.type, g = H[m].prototype, q,
                    u = ["group", "markerGroup", "dataLabelsGroup"], l = ["navigatorSeries", "baseSeries"],
                    p = f.finishedAnimating && {animation: !1};
                if (Object.keys && "data" === Object.keys(a).toString()) return this.setData(a.data,
                    c);
                l = u.concat(l);
                e(l, function (a) {
                    l[a] = f[a];
                ...
                a = h(k, p, {index: f.index, pointStart: f.xData[0]}, {data: f.options.data}, a);
                f.remove(!1, null, !1);
                for (q in g) f[q] = void 0;
                w(f, H[n || m].prototype);
                e(l, function (a) {
                    f[a] = l[a]
                });
    ...
    (function (a) {
        var x = a.each,
            E = a.map, C = a.pick, p = a.Series, m = a.seriesType;
        m("area", "line", {softThreshold: !1, threshold: 0}, {
            singleStacks: !1, getStackPoints: function (e) {
                var k = [], m = [], p = this.xAxis, n = this.yAxis, c = n.stacks[this.stackKey], d = {}, A = this.index,
                    h = n.series, f = h.length, b, u = C(n.options.reversedStacks, !0) ? 1 : -1, q;
                e = e || this.points;
                if (this.options.stacking) {
                    for (q = 0; q < e.length; q++) e[q].leftNull = e[q].rightNull = null, d[e[q].x] = e[q];
                    ...
                    x(m, function (a, e) {
                        var h = 0, t, z;
                        if (d[a] && !d[a].isNull) k.push(d[a]), x([-1, 1], function (h) {
                            var k = 1 === h ? "rightNull" : "leftNull", n = 0, r = c[m[e + h]];
                            if (r) for (q = A; 0 <= q && q < f;) t = r.points[q], t || (q === A ? d[a][k] = !0 : b[q] && (z = c[a].points[q]) && (n -= z[1] - z[0])), q += u;
                            ...
                            k.push({isNull: !0, plotX: p.translate(a, 0, 0, 0, 1), x: a, plotY: h, yBottom: h})
                        }
                    })
                }
                return k
                ...
                var e = p.prototype.getGraphPath,
                    m = this.options, t = m.stacking, n = this.yAxis, c, d, x = [], h = [], f = this.index, b,
                    u = n.stacks[this.stackKey], q = m.threshold, H = n.getThreshold(m.threshold), M,
                    m = m.connectNulls || "percent" === t, D = function (c, d, e) {
                        var k = a[c];
                        c = t && u[k.x].points[f];
                        var m = k[e + "Null"] || 0;
                        e = k[e + "Cliff"] || 0;
                        ...
                        void 0 !== r && (h.push({
                            ...
                            isNull: k,
                            isCliff: !0
                        }), x.push({plotX: b, plotY: null === p ? H : n.getThreshold(p), doCurve: !1}))
                    };
                a =
                    a || this.points;
                t && (a = this.getStackPoints(a));
                for (c = 0; c < a.length; c++) if (d = a[c].isNull, b = C(a[c].rectPlotX, a[c].plotX), M = C(a[c].yBottom, H), !d || m) m || D(c, c - 1, "left"), d && !t && m || (h.push(a[c]), x.push({
                    x: c,
                    plotX: b,
                    plotY: M
                })), m || D(c, c + 1, "right");
                ...
                var a = this, k = this.areaPath, m = this.options,
    ...
    (function (a) {
        ...
        a("spline", "line", {}, {
            getPointSpline: function (a,
                                      C, p) {
                var m = C.plotX, e = C.plotY, k = a[p - 1];
                p = a[p + 1];
                var w, t, n, c;
                ...
                C = ["C", x(k.rightContX, k.plotX), x(k.rightContY,
                    k.plotY), x(w, m), x(t, e), m, e];
    ...
    (function (a) {
        var x = a.seriesTypes.area.prototype, E = a.seriesType;
    ...
    (function (a) {
        var x = a.animObject, E = a.each, C = a.extend, p = a.isNumber, m = a.merge, e = a.pick, k = a.Series,
            w = a.seriesType, t = a.svg;
        w("column", "line", {
            borderRadius: 0,
            crisp: !0,
            groupPadding: .2,
            ...
            getColumnMetrics: function () {
                var a =
                    this, c = a.options, d = a.xAxis, k = a.yAxis, h = d.reversed, f, b = {}, m = 0;
                !1 === c.grouping ? m = 1 : E(a.chart.series, function (c) {
                    var d = c.options, e = c.yAxis, h;
                ...
                var q = Math.min(Math.abs(d.transA) * (d.ordinalSlope || c.pointRange || d.closestPointRange || d.tickInterval || 1), d.len),
                    p = q * c.groupPadding, t = (q - 2 * p) / (m || 1), c = Math.min(c.maxPointWidth ||
                    d.len, e(c.pointWidth, t * (1 - 2 * c.pointPadding)));
                a.columnMetrics = {
                    width: c,
            ...
            crispCol: function (a, c, d, e) {
                var h = this.chart, f = this.borderWidth, b = -(f % 2 ? .5 : 0), f = f % 2 ? .5 : 1;
            ...
            translate: function () {
                var a = this, c =
                        a.chart, d = a.options, m = a.dense = 2 > a.closestPointRange * a.xAxis.transA,
                    m = a.borderWidth = e(d.borderWidth, m ? 0 : 1), h = a.yAxis, f = d.threshold,
                    b = a.translatedThreshold = h.getThreshold(f), u = e(d.minPointLength, 5), q = a.getColumnMetrics(),
                    p = q.width, t = a.barW = Math.max(p, 1 + 2 * m), D = a.pointXOffset = q.offset;
                c.inverted && (b -= .5);
                d.pointPadding && (t = Math.ceil(t));
                k.prototype.translate.apply(a);
                E(a.points, function (d) {
                    var k = e(d.yBottom, b), m = 999 + Math.abs(k), m = Math.min(Math.max(-m, d.plotY), h.len + m),
                        n = d.plotX + D, q = t, w = Math.min(m, k),
                        F, g = Math.max(m, k) - w;
            ...
            drawPoints: function () {
                var a = this, c = this.chart, d = a.options, e = c.renderer, h = d.animationLimit || 250, f;
                E(a.points, function (b) {
                    var k = b.graphic;
                    if (p(b.plotY) && null !== b.y) {
                        f = b.shapeArgs;
                        if (k) k[c.pointCount < h ? "animate" : "attr"](m(f)); else b.graphic = k = e[b.shapeType](f).add(b.group || a.group);
                        d.borderRadius && k.attr({r: d.borderRadius});
                        k.addClass(b.getClassName(), !0)
                    } else k && (b.graphic = k.destroy())
                })
            },
            animate: function (a) {
                var c = this, d = this.yAxis, e = c.options, h = this.chart.inverted, f = {},
                    b = h ? "translateX" : "translateY",
                    k;
                t && (a ? (f.scaleY = .001, a = Math.min(d.pos + d.len, Math.max(d.pos, d.toPixels(e.threshold))), h ? f.translateX = a - d.len : f.translateY = a, c.group.attr(f)) : (k = c.group.attr(b), c.group.animate({scaleY: 1}, C(x(c.options.animation), {
                    step: function (a, e) {
                        f[b] = k + e.pos * (d.pos - k);
                        c.group.attr(f)
                    }
    ...
    (function (a) {
        ...
        a("scatter", "line", {
            ...
            sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "markerGroup",
                "dataLabelsGroup"], takeOrdinalPosition: !1, drawGraph: function () {
                this.options.lineWidth && x.prototype.drawGraph.call(this)
            }
        })
    })(K);
    (function (a) {
        var x = a.deg2rad, E = a.isNumber, C = a.pick, p = a.relativeLength;
        a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, e = this.chart, k = 2 * (a.slicedOffset || 0), w = e.plotWidth - 2 * k,
                    e = e.plotHeight - 2 * k, t = a.center,
                    t = [C(t[0], "50%"), C(t[1], "50%"), a.size || "100%", a.innerSize || 0], n = Math.min(w, e), c, d;
                for (c = 0; 4 > c; ++c) d = t[c], a = 2 > c || 2 === c && /%$/.test(d), t[c] = p(d, [w, e, n, t[2]][c]) +
                    (a ? k : 0);
                t[3] > t[2] && (t[3] = t[2]);
                return t
                ...
                return {start: x * (a + -90), end: x * (e + -90)}
            }
        }
    })(K);
    (function (a) {
        var x = a.addEvent, E = a.CenteredSeriesMixin, C = a.defined, p = a.each, m = a.extend,
            e = E.getStartAndEndRadians, k = a.inArray, w = a.noop, t = a.pick, n = a.Point, c = a.Series,
            d = a.seriesType, A = a.setAnimation;
        d("pie", "line", {
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            animate: function (a) {
                ...
                a || (p(b, function (a) {
                    ...
                    b && (b.attr({r: a.startR || c.center[3] / 2, start: d, end: d}),
                        b.animate({r: f.r, start: f.start, end: f.end}, c.options.animation))
                }), c.animate = null)
            },
            updateTotals: function () {
                var a, c = 0, b = this.points, d = b.length, e, k = this.options.ignoreHiddenPoint;
                for (a = 0; a < d; a++) e = b[a], c += k && !e.visible ? 0 : e.isNull ? 0 : e.y;
                this.total = c;
                for (a = 0; a < d; a++) e = b[a], e.percentage = 0 < c && (e.visible || !k) ? e.y / c * 100 : 0, e.total = c
            },
            generatePoints: function () {
            ...
            translate: function (a) {
                this.generatePoints();
                var c = 0, b = this.options, d = b.slicedOffset, h = d + (b.borderWidth ||
                    0), k, m, n, p = e(b.startAngle, b.endAngle), z = this.startAngleRad = p.start,
                    p = (this.endAngleRad = p.end) - z, r = this.points, y, w = b.dataLabels.distance,
                    b = b.ignoreHiddenPoint, x, A = r.length, g;
            ...
            drawPoints: function () {
                ...
                p(a.points, function (f) {
                    d = f.graphic;
                    f.isNull ? d && (f.graphic = d.destroy()) : (e = f.shapeArgs, b = f.getTranslate(), d ? d.setRadialReference(a.center).animate(m(e, b)) : (f.graphic = d = c[f.shapeType](e).setRadialReference(a.center).attr(b).add(a.group),
            ...
            init: function () {
                ...
                var b = this, f = b.series, d = f.chart, e = f.options.ignoreHiddenPoint;
                c = t(c, e);
    ...
    (function (a) {
        var x = a.addEvent, E = a.arrayMax, C = a.defined, p = a.each, m = a.extend, e = a.format, k = a.map,
            w = a.merge,
            t = a.noop, n = a.pick, c = a.relativeLength, d = a.Series, A = a.seriesTypes, h = a.stableSort;
        a.distribute = function (a, b) {
            ...
            var f, d = !0, e = a, m = [], t;
            t = 0;
            for (f = a.length; f--;) t += a[f].size;
            if (t > b) {
                h(a, function (a, b) {
                    return (b.rank || 0) - (a.rank || 0)
                });
                for (t = f = 0; t <= b;) t += a[f].size, f++;
            ...
            for (a = k(a, function (a) {
                ...
                for (f = a.length; f--;) d = a[f], t = (Math.min.apply(0, d.targets) + Math.max.apply(0, d.targets)) /
                    2, d.pos = Math.min(Math.max(0, t - d.size * d.align), b - d.size);
                f = a.length;
                for (d = !1; f--;) 0 < f && a[f - 1].pos + a[f - 1].size > a[f].pos && (a[f - 1].size += a[f].size, a[f - 1].targets = a[f - 1].targets.concat(a[f].targets), a[f - 1].align = .5, a[f - 1].pos + a[f - 1].size > b && (a[f - 1].pos = b - a[f - 1].size), a.splice(f, 1), d = !0)
            }
            f = 0;
            p(a, function (a) {
                var b = 0;
        ...
        d.prototype.drawDataLabels = function () {
            ...
            var b = this, d = b.chart, k = b.options, h = k.dataLabels, m = b.points, t, F, z = b.hasRendered || 0, r,
                y, G = n(h.defer, !!k.animation), B = d.renderer;
            if (h.enabled || b._hasPointLabels) b.dlProcessOptions && b.dlProcessOptions(h), y = b.plotGroup("dataLabelsGroup", "data-labels", G && !z ? "hidden" : "visible", h.zIndex || 6), G && (y.attr({opacity: +z}), z || x(b, "afterAnimate", function () {
                b.visible && y.show(!0);
                y[k.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
            })), F = h, p(m, function (f) {
                var g, k = f.dataLabel, m, l, q = f.connector, p = !k, u;
        ...
        d.prototype.alignDataLabel = function (a, b, c, d,
                                               e) {
            var f = this.chart, k = f.inverted, h = n(a.dlBox && a.dlBox.centerX, a.plotX, -9999),
                q = n(a.plotY, -9999), r = b.getBBox(), p, u = c.rotation, t = c.align,
            ...
            if (w && (p = f.renderer.fontMetrics(void 0, b).b, d = m({
                    ...
                    width: 0,
                    height: 0
                }, d), m(c, {width: r.width, height: r.height}), u ? (g = !1, h = f.renderer.rotCorr(p, u), h = {
                    x: d.x + c.x +
                    d.width / 2 + h.x, y: d.y + c.y + {top: 0, middle: .5, bottom: 1}[c.verticalAlign] * d.height
                }, b[e ? "attr" : "animate"](h).attr({align: t}), q = (u + 720) % 360, q = 180 < q && 360 > q, "left" === t ? h.y -= q ? r.height : 0 : "center" === t ? (h.x -= r.width / 2, h.y -= r.height / 2) : "right" === t && (h.x -= r.width, h.y -= q ? 0 : r.height)) : (b.align(c, null, d), h = b.alignAttr), g ? a.isLabelJustified = this.justifyDataLabel(b, c, h, r, d, e) : n(c.crop, !0) && (w = f.isInsidePlot(h.x, h.y) && f.isInsidePlot(h.x + r.width, h.y + r.height)), c.shape && !u)) b[e ? "attr" : "animate"]({
                anchorX: k ? f.plotWidth -
                    a.plotY : a.plotX, anchorY: k ? f.plotHeight - a.plotX : a.plotY
            });
            w || (b.attr({y: -9999}), b.placed = !1)
        };
        d.prototype.justifyDataLabel = function (a, b, c, d, e, h) {
            var f = this.chart, k = b.align, m = b.verticalAlign, n, q, p = a.box ? 0 : a.padding || 0;
            n = c.x + p;
            ...
            n = c.y + d.height - p;
            n > f.plotHeight && ("top" === m ? b.verticalAlign = "bottom" : b.y = f.plotHeight -
                n, q = !0);
            q && (a.placed = !h, a.align(b, null, e));
            return q
        };
        A.pie && (A.pie.prototype.drawDataLabels = function () {
            var c = this, b = c.data, e, h = c.chart, k = c.options.dataLabels, m = n(k.connectorPadding, 10),
                t = n(k.connectorWidth, 1), w = h.plotWidth, z = h.plotHeight, r, y = c.center, x = y[2] / 2, B = y[1],
                A, g, v, L, l = [[], []], J, K, Q, P, O = [0, 0, 0, 0];
            c.visible && (k.enabled || c._hasPointLabels) && (p(b, function (a) {
                ...
                var d, l, r = b.length, q = [], t;
                if (r) for (c.sortByAngle(b, f - .5), 0 < c.maxLabelDistance && (d = Math.max(0, B - x - c.maxLabelDistance), l = Math.min(B + x + c.maxLabelDistance, h.plotHeight), p(b, function (a) {
                    0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, B - x - a.labelDistance), a.bottom = Math.min(B + x + a.labelDistance, h.plotHeight), t = a.dataLabel.getBBox().height || 21, a.positionsIndex = q.push({
                        target: a.labelPos[1] -
                        a.top + t / 2, size: t, rank: a.y
                    }) - 1)
                }), a.distribute(q, l + t - d)), P = 0; P < r; P++) e = b[P], l = e.positionsIndex, v = e.labelPos, A = e.dataLabel, Q = !1 === e.visible ? "hidden" : "inherit", K = d = v[1], q && C(q[l]) && (void 0 === q[l].pos ? Q = "hidden" : (L = q[l].size, K = e.top + q[l].pos)), delete e.positionIndex, J = k.justify ? y[0] + (f ? -1 : 1) * (x + e.labelDistance) : c.getX(K < e.top + 2 || K > e.bottom - 2 ? d : K, f, e), A._attr = {
                    visibility: Q,
                    align: v[6]
                }, A._pos = {
                    x: J + k.x + ({left: m, right: -m}[v[6]] || 0),
                    y: K + k.y - 10
                }, v.x = J, v.y = K, n(k.crop, !0) && (g = A.getBBox().width, d = null, J - g < m ? (d =
                    Math.round(g - J + m), O[3] = Math.max(d, O[3])) : J + g > w - m && (d = Math.round(J + g - w + m), O[1] = Math.max(d, O[1])), 0 > K - L / 2 ? O[0] = Math.max(Math.round(-K + L / 2), O[0]) : K + L / 2 > z && (O[2] = Math.max(Math.round(K + L / 2 - z), O[2])), A.sideOverflow = d)
                ...
                if ((A = a.dataLabel) && A._pos && a.visible && 0 < a.labelDistance) {
                    ...
                    if (b = !r) a.connector = r = h.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" +
            ...
            var b = this.center, d = this.options, f = d.center, e = d.minSize || 80, h, k = null !== d.size;
            k || (null !== f[0] ? h = Math.max(b[2] - Math.max(a[1], a[3]), e) : (h = Math.max(b[2] - a[1] - a[3], e), b[0] += (a[3] - a[1]) /
                2), null !== f[1] ? h = Math.max(Math.min(h, b[2] - Math.max(a[0], a[2])), e) : (h = Math.max(Math.min(h, b[2] - a[0] - a[2]), e), b[1] += (a[0] - a[2]) / 2), h < b[2] ? (b[2] = h, b[3] = Math.min(c(d.innerSize || 0, h), h), this.translate(b), this.drawDataLabels && this.drawDataLabels()) : k = !0);
            return k
        });
        A.column && (A.column.prototype.alignDataLabel = function (a, b, c, e, h) {
            var f = this.chart.inverted, k = a.series, m = a.dlBox || a.shapeArgs,
                p = n(a.below, a.plotY > n(this.translatedThreshold, k.yAxis.len)),
                r = n(c.inside, !!this.options.stacking);
            m && (e = w(m), 0 > e.y &&
            (e.height += e.y, e.y = 0), m = e.y + e.height - k.yAxis.len, 0 < m && (e.height -= m), f && (e = {
    ...
    (function (a) {
        ...
        a(x.prototype, "render", function () {
            ...
            E(this.series || [], function (e) {
                var k = e.options.dataLabels, m = e.dataLabelCollections || ["dataLabel"];
                (k.enabled || e._hasPointLabels) && !k.allowOverlap && e.visible && E(m, function (k) {
                    E(e.points, function (e) {
                        e[k] && (e[k].labelrank =
                            p(e.labelrank, e.shapeArgs && e.shapeArgs.height), a.push(e[k]))
                    })
                })
            });
        ...
        x.prototype.hideOverlappingLabels = function (a) {
            var e = a.length, k, m, p, n, c, d, x, h, f, b = function (a, b, c, d, e, f, h, k) {
                return !(e > a + c || e + h < a || f > b + d || f + k < b)
            };
            for (m = 0; m < e; m++) if (k = a[m]) k.oldOpacity = k.opacity, k.newOpacity = 1, k.width || (p = k.getBBox(), k.width = p.width, k.height = p.height);
            a.sort(function (a, b) {
                return (b.labelrank || 0) - (a.labelrank || 0)
            });
            for (m = 0; m < e; m++) for (p = a[m], k = m + 1; k < e; ++k) if (n = a[k], p && n && p !== n && p.placed &&
                n.placed && 0 !== p.newOpacity && 0 !== n.newOpacity && (c = p.alignAttr, d = n.alignAttr, x = p.parentGroup, h = n.parentGroup, f = 2 * (p.box ? 0 : p.padding || 0), c = b(c.x + x.translateX, c.y + x.translateY, p.width - f, p.height - f, d.x + h.translateX, d.y + h.translateY, n.width - f, n.height - f))) (p.labelrank < n.labelrank ? p : n).newOpacity = 0;
            E(a, function (a) {
                var b, c;
    ...
    (function (a) {
        var x =
                a.addEvent, E = a.Chart, C = a.createElement, p = a.css, m = a.defaultOptions, e = a.defaultPlotOptions,
            k = a.each, w = a.extend, t = a.fireEvent, n = a.hasTouch, c = a.inArray, d = a.isObject, A = a.Legend,
            h = a.merge, f = a.pick, b = a.Point, u = a.Series, q = a.seriesTypes, H = a.svg, K;
        K = a.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                var a = this, b = a.options.trackByArea, c = [].concat(b ? a.areaPath : a.graphPath), d = c.length,
                    e = a.chart, f = e.pointer, h = e.renderer, m = e.options.tooltip.snap, g = a.tracker, p,
                    q = function () {
                        if (e.hoverSeries !== a) a.onMouseOver()
                    },
                    l = "rgba(192,192,192," + (H ? .0001 : .002) + ")";
                if (d && !b) for (p = d + 1; p--;) "M" === c[p] && c.splice(p + 1, 0, c[p + 1] - m, c[p + 2], "L"), (p && "M" === c[p] || p === d) && c.splice(p, 0, "L", c[p - 2] + m, c[p - 1]);
        ...
        w(E.prototype, {
            showResetZoom: function () {
                ...
                var b = this, c = m.lang, d = b.options.chart.resetZoomButton, e = d.theme, f = e.states,
            ...
            zoom: function (a) {
                ...
                k("xy" === b ? [1, 0] : [1], function (b) {
                    ...
                    var d = b.horiz, f = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", g = c[d],
                        ...
                        m = b.toValue(g + b.len - f, !0) - h, n = m < l, g = n ? m : l, l = n ? l : m,
                    ...
                    n = l - h;
                    0 < n && (l = h, g -= n);
                    b.series.length && g !== k.min && l !== k.max && (b.setExtremes(g,
                        l, !1, !1, {trigger: "pan"}), e = !0);
                    c[d] = f
                });
                e && c.redraw(!1);
        ...
        w(b.prototype, {
            select: function (a, b) {
                var d = this, e = d.series, h = e.chart;
                a = f(a, !d.selected);
            ...
            onMouseOver: function (a) {
                ...
                if (!this.hasImportedEvents) {
                    var b = this, c = h(b.series.options.point, b.options).events;
                    b.events = c;
                    ...
                    this.hasImportedEvents = !0
                                   ...
                                   b) {
                var c = Math.floor(this.plotX), d = this.plotY, h = this.series,
                    k = h.options.states[a || "normal"] || {}, m = e[h.type].marker && h.options.marker,
                    n = m && !1 === m.enabled, g = m && m.states && m.states[a || "normal"] || {}, p = !1 === g.enabled,
                    q = h.stateMarkerGraphic, l = this.marker || {}, u = h.chart, w = h.halo, x,
                    A = m && h.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === k.enabled || a && (p || n && !1 === g.enabled) || a && l.states && l.states[a] && !1 === l.states[a].enabled)) {
                    ...
                    this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), x && this.graphic.animate(x, f(u.options.chart.animation, g.animation, m.animation)), q && q.hide(); else {
                        if (a && g) if (m = l.symbol || h.symbol, q && q.currentSymbol !== m && (q = q.destroy()), q) q[b ? "animate" : "attr"]({
                            x: x.x,
                            y: x.y
                        }); else m && (h.stateMarkerGraphic = q = u.renderer.symbol(m, x.x, x.y, x.width, x.height).add(h.markerGroup), q.currentSymbol = m);
                        q && (q[a && u.isInsidePlot(c, d, u.inverted) ? "show" : "hide"](), q.element.point =
                            this)
                    }
    ...
    (function (a) {
        var x = a.Chart, E = a.each, C = a.inArray, p = a.isArray,
            m = a.isObject, e = a.pick, k = a.splat;
        x.prototype.setResponsive = function (e) {
            var k = this.options.responsive, m = [], c = this.currentResponsive;
        ...
        x.prototype.currentOptions = function (e) {
            function t(c, d, e, h) {
                var f;
                a.objectEach(c, function (a, c) {
                    if (!h && -1 < C(c, ["series", "xAxis", "yAxis"])) for (a = k(a), e[c] = [], f = 0; f <
                    a.length; f++) d[c][f] && (e[c][f] = {}, t(a[f], d[c][f], e[c][f], h + 1)); else m(a) ? (e[c] = p(a) ? [] : {}, t(a, d[c] || {}, e[c], h + 1)) : e[c] = d[c] || null
                })
            }
